...
#  mount Resque::Server, at: '/jobs'
  ...
  match "hbx_profiles/edit_eligibility" => "exchanges/hbx_profiles#edit_eligibility", as: :edit_eligibility, via: [:get], defaults: { format: 'js' }
  match "hbx_profiles/update_eligibility" => "exchanges/hbx_profiles#update_eligibility", as: :update_eligibility, via: [:post], defaults: { format: 'js' }
