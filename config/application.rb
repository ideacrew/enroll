...
module Enroll
  class Application < Rails::Application
    ...
    unless Rails.env.test?
      ...
      config.acapi.add_amqp_worker("FinancialAssistance::Subscribers::GenerateRenewalDraft")
      config.acapi.add_amqp_worker("FinancialAssistance::Subscribers::SubmitRenewalDraft")
