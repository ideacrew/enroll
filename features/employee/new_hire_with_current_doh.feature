Feature: New hire with current date of hire
  ...
  And Employee should be able to purchase Insurance
	...
	Scenario: New hire does not have new hire enrollment window

  Scenario: New hire has valid enrollment window
