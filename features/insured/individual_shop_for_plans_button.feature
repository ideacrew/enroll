Feature: Insured Plan Shopping on Individual market
  ...
  Scenario: New insured user purchases on individual market during OE with no SEP
    ...
    When I can click on Shop for Plans link
    Then I should land on Coverage household page
