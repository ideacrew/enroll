...
module HbxAdminWorld
  def hbx_admin(*traits)
    p_staff = Permission.create(name: 'hbx_staff', modify_family: true, modify_employer: true, revert_application: true, list_enrollments: true,
                                ...
                                can_complete_resident_application: true, can_call_hub: true, can_add_sep: true, can_view_username_and_email: true, can_view_application_types: true, view_personal_info_page: true,
