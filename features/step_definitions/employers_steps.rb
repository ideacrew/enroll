...
Given /^the employer has (.*?) plan year$/ do |aasm_state|
  ...
  employer_profile.application_accepted!
  @custom_plan_year = create(:custom_plan_year, employer_profile: employer_profile, start_on: TimeKeeper.date_of_record.beginning_of_month, aasm_state: aasm_state, with_dental: false)
end
