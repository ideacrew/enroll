...
When(/^.+ enters? the info of his dependent wife$/) do
  ...
  sleep 1
  find(:xpath, '//*[@id="new_dependent"]/div[1]/div[5]/div[1]/div[3]/div/div[2]/span').click
  find(:xpath, '//*[@id="new_dependent"]/div[1]/div[5]/div[1]/div[3]/div/div[3]/div/ul/li[2]').click
