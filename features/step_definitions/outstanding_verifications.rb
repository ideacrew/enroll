Given(/^oustanding verfications users exists$/) do
  ...
  enrollment = FactoryGirl.create(:hbx_enrollment, :with_enrollment_members, household: family.active_household, aasm_state: "coverage_selected", is_any_enrollment_member_outstanding: true,  kind: "individual", effective_on: TimeKeeper.date_of_record.beginning_of_year)
