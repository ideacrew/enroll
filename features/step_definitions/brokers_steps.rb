...
Then(/^.+ should see broker selected successful message$/) do
  expect(page).to have_content("Your broker has been notified of your selection and should contact you shortly. You can always call or email them directly, but if this is not the broker you want to use, select 'Change Broker'.")
end
