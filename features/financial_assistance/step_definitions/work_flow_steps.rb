...
#   expect(page).to have_content('Thank you. Next, we need to verify if you or you and your family are eligible to enroll in coverage through OPM.gov. Please select CONTINUE.')
#   find('.btn', text: 'CONTINUE').click
