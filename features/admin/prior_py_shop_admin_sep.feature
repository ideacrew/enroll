Feature: SHOP employee or Admin adding a SEP which falls in prior plan year,
  ...
  Scenario: Hbx Admin adding SHOP sep in prior plan year for employee with
            no prior, active  or renewal coverage and renewal flag is unchecked and
  ...
  Scenario: Hbx Admin adding SHOP sep in prior plan year for employee with
            prior, active coverage  and no renewal coverage and renewal flag is unchecked and
            employer having expired, active and renewing py
  ...
  Scenario: Hbx Admin adding SHOP sep in prior plan year for employee with
            prior, active coverage  and renewal coverage and renewal flag is unchecked and
            employer having expired, active and renewing py
