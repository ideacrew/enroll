...
Gem::Specification.new do |s|
  ...
  s.summary     = "Builders that create applications for various spnosored benefits"
  s.description = "Builders that create applications for various spnosored benefits"
  s.license     = "MIT"
