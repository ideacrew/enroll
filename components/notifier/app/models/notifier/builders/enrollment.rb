module Notifier
  module Builders::Enrollment
    ...
    def enrollment_coverage_end_on_minus_60_days
      return if enrollment.blank?
      merge_model.enrollment.reporting_deadline_beginning = format_date(enrollment_coverage_end_on - 60.days)
    end

    def enrollment_coverage_end_on_plus_60_days
      return if enrollment.blank?
      merge_model.enrollment.reporting_deadline_ending = format_date(enrollment.terminated_on + 60.days)
    end
