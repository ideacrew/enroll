...
module Notifier
  module ConsumerRoleHelper
    ...
    def ivl_oe_start_date_value
      start_on_month = EnrollRegistry[:open_enrollment_start_on].settings(:month).item
      start_on_day = EnrollRegistry[:open_enrollment_start_on].settings(:day).item
      start_on_year = EnrollRegistry[:open_enrollment_start_on].settings(:year).item
      Date.new(start_on_year,start_on_month,start_on_day).strftime('%B %d, %Y')
    end

    def ivl_oe_end_date_value
      end_on_month = EnrollRegistry[:open_enrollment_end_on].settings(:month).item
      end_on_day = EnrollRegistry[:open_enrollment_end_on].settings(:day).item
      end_on_year = EnrollRegistry[:open_enrollment_end_on].settings(:year).item
      Date.new(end_on_year,end_on_month,end_on_day).strftime('%B %d, %Y')
    end
