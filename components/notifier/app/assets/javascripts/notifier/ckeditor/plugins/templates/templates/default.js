...
CKEDITOR.addTemplates('default', {
  ...
  templates: [
    ...
    },
    {
      ...
      image: 'template1.gif',
      description:
        'Standard template for the notices received by General Agencies.',
      html:
        '<p>&nbsp;</p>' +
        ...
        '<li>TTY: #{EnrollRegistry[:enroll_app].setting(:contact_center_tty_number).item}</li>' +
    ...
    },
    {
      ...
      html:
        ...
        '<br />' +
        'The #{EnrollRegistry[:enroll_app].setting(:short_name).item} Team<br />' +
        '<br />' +
