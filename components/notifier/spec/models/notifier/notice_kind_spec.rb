  ...
  RSpec.describe NoticeKind, type: :model do
    ...
    describe '.set_data_elements' do
      ...
      before do
        ...
        allow(subject).to receive(:conditional_tokens).and_return(["employer_profile.addresses.each do | address |", "employer_profile.offered_products.each do | offered_product |", "page_number", "offered_product.enrollments.each do | enrollment |"])
      end
