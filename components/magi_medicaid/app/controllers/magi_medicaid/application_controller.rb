...
module MagiMedicaid
  class ApplicationController < ::ApplicationController
    ...
    before_action :verify_assistance_enabled
    ...
    def verify_assistance_enabled
      return render(file: 'public/404.html', status: 404) unless ::EnrollRegistry.feature_enabled?(:magi_medicaid)
      true
    end
