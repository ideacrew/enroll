...
if ExchangeTestingConfigurationHelper.individual_market_is_enabled?
  RSpec.describe FinancialAssistance::Locations::AddressPolicy, type: :model do
    ...
    permissions :destroy? do
      ...
      context 'when a valid user is logged in' do
        context 'when the user is a consumer' do
          let(:user_of_family) { FactoryBot.create(:user, person: primary) }
          let(:logged_in_user) { user_of_family }

          context 'with ridp verified' do
            it 'grants access' do
              expect(subject).to permit(logged_in_user, address)
            end
          end
          ...
          context 'without ridp verified' do
            it 'denies access' do
              ...
              expect(subject).not_to permit(logged_in_user, address)
            end
          end
        end
