    ...
    context "and the incoming payload and existing attributes are same but attributes order changed" do
      ...
      let!(:applicant) do
        appl = FactoryBot.create(:financial_assistance_applicant,
                                 ...
                                 :family_member_id => BSON::ObjectId('5f60c648bb40ee0c3d288a83'),
                                 :relationship => "child")
        appl.addresses = [FactoryBot.build(
        ...
        appl.phones = [FactoryBot.build(
          :financial_assistance_phone,
          :area_code => '202',
          :country_code => '',
          :extension => '1',
          :full_phone_number => '20211111111',
      ...
      let!(:applicant_params) do
        {:addresses => [{:address_1 => '1112 Awesome Street', :address_2 => '#112', :address_3 => '', :city => 'Washington', :country_name => '', :kind => 'home', :state => 'DC', :zip => '20001', county: ''},
