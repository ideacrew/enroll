...
RSpec.describe ::FinancialAssistance::Operations::Applications::MedicaidGateway::AddMecCheck, dbclean: :after_each do
  ...
  context 'Given a valid payload' do
    ...
    it 'should update the mec_check_response field to true' do
    ...
    it 'should update applicant mec check response' do
      updated_application = FinancialAssistance::Application.find(application_id)
      updated_applicant = updated_application.applicants.first
      expect(updated_applicant.mec_check_response).to eq "Applicant Not Found"
    end

    it 'should update applicant mec check date' do
      updated_application = FinancialAssistance::Application.find(application_id)
      updated_applicant = updated_application.applicants.first
      expect(updated_applicant.mec_check_date).not_to be_nil
    end
  end
end