    ...
    {:family_reference => {:hbx_id => "10011"},
     ...
     :applicants =>
       [{:name => {:first_name => "Gerald", :last_name => "Rivers"},
         ...
         :demographic => {:gender => "Male", :dob => member_dob, :is_veteran_or_active_military => false},
         :attestation => {:is_incarcerated => false, :is_self_attested_disabled => true, :is_self_attested_blind => false},
         ...
         {:family_member_hbx_id => "1000", :first_name => "Gerald", :last_name => "Rivers", :person_hbx_id => "95", :is_primary_family_member => true},
         :person_hbx_id => "95",
         ...
         :pregnancy_information => {:is_pregnant => false, :is_post_partum_period => false, :expected_children_count => nil},
         ...
         :medicaid_and_chip => {:not_eligible_in_last_90_days => true, :denied_on => Date.today},
         :addresses =>
         ...
         :incomes => [{:kind => "wages_and_salaries", :amount => 0.16e5, :frequency_kind => "Annually", :start_on => Date.today.beginning_of_year}],
         ...
         :benchmark_premium =>
         {:health_only_lcsp_premiums => [{:member_identifier => "95", :monthly_premium => 0.43048e3}],
          :health_only_slcsp_premiums => [{:member_identifier => "95", :monthly_premium => 0.49602e3}]},
         :is_homeless => false,
         :mitc_income =>
         {:amount => 14976,
          :taxable_interest => 0,
     ...
     :tax_households =>
      [{:max_aptc => 0.496e3,
        ...
        [{:product_eligibility_determination => 
          ...
          :applicant_reference => {:first_name => "Gerald", :last_name => "Rivers", :dob =>  member_dob, :person_hbx_id => "95"}}]}],
    :relationships => [],
    :us_state => "DC",
    :hbx_id => "200000126",
