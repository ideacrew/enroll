...
FINANCIAL_ASSISTANCE_TRANSLATIONS = {
  ...
  "en.faa.non_oe_see_if_you_qualify_1" => "Select if you've experienced a life change and need to enroll through a Special Enrollment Period or make an update to your %{calendar_year} application.",
