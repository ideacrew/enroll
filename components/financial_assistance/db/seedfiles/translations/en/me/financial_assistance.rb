...
FINANCIAL_ASSISTANCE_TRANSLATIONS = {
  ...
  "en.faa.other_incomes.unsaved" => "You Have Unsaved Changes",
  "en.faa.other_incomes.confirm_deletion" => "Confirm Deletion",
  "en.faa.other_incomes.leave_warning" => "If you leave without saving, you will lose all your changes.",
  "en.faa.other_incomes.cannot_be_undone" => "This cannot be undone.",
  "en.faa.other_incomes.stay" => "Stay on this Page",
  "en.faa.other_incomes.leave" => "Leave Without Saving",
  "en.faa.other_incomes.sure_remove" => "Are you sure you want to remove everything you have entered for this income?",
  "en.faa.other_incomes.dont_remove" => "Don't Remove",
