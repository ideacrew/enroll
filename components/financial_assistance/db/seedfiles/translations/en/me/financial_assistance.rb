...
FINANCIAL_ASSISTANCE_TRANSLATIONS = {
  ...
  "en.faa.report_changes_1" => "I can report changes by going online and logging into my account, by calling <%= EnrollRegistry[:enroll_app].setting(:short_name).item %> at #{Settings.contact_center.phone_number},",
  ...
  "en.faa.year_selection_learn_more" => "If you need health insurance, lower premiums, or Medicaid now, you can <a href='#'>submit a webform</a> or call <%= EnrollRegistry[:enroll_app].setting(:short_name).item %> at (855) 532-5465 / TTY: 711. <a target='_blank' href='https://www.dchealthlink.com/individuals/life-changes'>Learn more about Life Changes</a>.", # TODO: Update URL and phones
