...
FINANCIAL_ASSISTANCE_TRANSLATIONS = {
  "en.faa.curam_lookup" => "It looks like you've already completed an application for Medicaid and cost savings
     . Please call IdeaCrew at (866) 636-0355 to make updates to that application.
      If you keep going, we'll check to see if you qualify to enroll in a private health insurance plan , but won't be able to tell you if you qualify for Medicaid or cost savings.",
  "en.faa.acdes_lookup" => "It looks like you're already covered by Medicaid.
     Please call IdeaCrew at (866) 636-0355 to make updates to your case.
     If you keep going, we'll check to see if you qualify to enroll in a private health insurance plan , but won't be able to tell you if you qualify for Medicaid or cost savings.",
  ...
  "en.faa.medicaid" => "Medicaid and CHIP",
  "en.faa.eligible_for_medicaid" => "These people <span>appear to be eligible</span> for ",
  "en.faa.eligible_for_medicaid2" => "Medicaid or CHIP (the Children's Health Insurance Program). Because of this, they do not qualify for a tax credit:",
  "en.faa.dhs_decision" => "<span>Next step: The Office for Family Independence will make a final decision on whether those listed qualify for <span class='run-glossary'>Medicaid and CHIP</span>.</span>",
  ...
  "en.faa.qualified_reason" => "These people may qualify for Medicaid for reasons like age or disability.",
  ...
  "en.faa.does_not_qualify_text" => "These people likely don't qualify for Medicaid , and don't qualify for private health insurance through the State Based Marketplace.",
  "en.faa.likely_does_not_qualify" => "These people <span> likely don't qualify for ",
  "en.faa.likely_does_not_qualify2" => "</span>, and don't qualify for private health insurance through the State Based Marketplace:",
  ...
  "en.faa.medicaid_not_eligible" => "Was this person found not eligible for Medicaid or CHIP (Children's Health Insurance Program) within the last 90 days? *",
  "en.faa.medicaid_cubcare_end_date" => "When was this person denied Medicaid or CHIP (Children's Health Insurance Program)? *",
  "en.faa.change_eligibility_status" => "Did this person have Medicaid or CHIP (Children's Health Insurance Program) that will end soon or that recently ended because of a change in eligibility? *",
  ...
  "en.faa.person_medicaid_last_day" => "What is the last day of this person’s Medicaid or CHIP (CHIP) coverage? *",
  "en.faa.medicaid_chip_ineligible" => "Was this person found not eligible for Medicaid or CHIP (Children's Health Insurance Program) based on their immigration status since",
  "en.faa.immigration_status_changed" => "Has this person’s immigration status changed since they were not found eligible for Medicaid or CHIP (Children’s Health Insurance Program)",
  ...
  "en.faa.question.child_health_insurance_plan" => "CHIP (Children's Health Insurance Program)",
  ...
  "en.faa.i_understand_evaluation_1" => "I understand that my application will be used to evaluate eligibility for Medicaid and CHIP (Children’s Health Insurance Program) ",
  "en.faa.i_understand_evaluation_2" => "and will be sent to the Office for Family Independence for a final eligibility determination if anyone is likely to qualify for Medicaid or CHIP.  ",
  ...
  "en.faa.anyone_found_eligible_1" => "If anyone in my application group is found eligible for Medicaid, I am authorizing the Office for Family Independence to pursue and get any money from other health insurance, ",
  ...
  "en.faa.eligibility_go_to_my_account_message" => "If you've already enrolled in an IdeaCrew Individual & Family plan, you're finished! You'll see your updated plan in a minute or two. Select <b>GO TO MY ACCOUNT</b>.",
  ...
  # Mec check
  "en.faa.mc_success" => "It looks like you may already be enrolled in Medicaid or CHIP. If you need to update information like your income, address, or who is in your household, contact the Office for Family Independence at <a href='tel:855-797-4357'>(855) 797-4357</a> to make these changes before completing an IdeaCrew application.",
  "en.faa.shop_check_success" => "It looks like you may already be enrolled in employer sponsored coverage. If you need to update information like your income, address, or who is in your household, visit the Manage Family page to make these changes before completing an IdeaCrew application.",
  "en.faa.mc_continue" => "Select 'CONTINUE' if you would still like to complete an IdeaCrew application.",
  ...
  "en.faa.results.all_medicaid_next_steps_continue_text" => "Medicaid coverage is free. If you would like to enroll and pay full price for an insurance plan through %{short_name}, select 'Return to Account Home' to see if you are eligible to select a plan or make changes to your current plan.",
