...
FINANCIAL_ASSISTANCE_TRANSLATIONS = {
  ...
  "en.faa.incomes.from_employer" => "Does this person have <strong>income from an employer</strong>, or expect to have it in %{assistance_year}?*",
  "en.faa.incomes.from_self_employment" => "Does this person have <strong>self-employment income</strong>, or expect to have it in %{assistance_year}?*",
  ...
  "en.faa.other_incomes.other_sources" => "Does this person have <strong>income from other sources</strong>, or expect to have it in %{assistance_year}?*",
  "en.faa.deductions.income_adjustments" => "Does this person have <strong>adjustments to income</strong>, or expect to have them in %{assistance_year}?*",
