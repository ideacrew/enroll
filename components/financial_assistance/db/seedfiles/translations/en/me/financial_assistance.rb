...
FINANCIAL_ASSISTANCE_TRANSLATIONS = {
  ...
  "en.faa.results.csr_0_or_100_text" => "These people also qualify for lower out-of-pockets costs called Cost Sharing Reductions. They also won't pay anything for services they receive from an Indian Health Service provider.",
