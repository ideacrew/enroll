...
FINANCIAL_ASSISTANCE_TRANSLATIONS = {
  ...
  "en.faa.end_date_warning" => "<strong>End Date: </strong>Leave the %{end_date_field_label} field empty, unless you expect your income to end on a certain date (for example, if you have a seasonal job). Do not enter the last day of the year unless you know that you will not have this income the following year.",
