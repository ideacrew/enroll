...
FINANCIAL_ASSISTANCE_TRANSLATIONS = {
  ...
  "en.faa.last_step" => "This is the last step. Carefully read the information below. Select 'I agree' after each statement to acknowledge your agreement. Then, enter your name to electronically sign the application. When you're finished, select SUBMIT APPLICATION.",
  ...
  "en.faa.renewal_process" => "This process is called renewal. #{Settings.site.short_name} will review eligibility by checking its records and other electronic data sources including, with my consent, information about my federal tax returns from the IRS.",
  "en.faa.send_notice" => "",
  ...
  "en.faa.report_changes" => "I can report changes by going online and logging into my account, by calling #{Settings.site.short_name} at #{Settings.contact_center.phone_number}, or by submitting information via mail.",
  "en.faa.signature_line_below" => "I'm the person whose name appears in the signature line below. I understand that I'm submitting an application for health insurance and that information that I provided will be used to decide eligibility for each member of my application group.",
  "en.faa.i_understand_evaluation" => "I understand that my application will be used to evaluate eligibility for MaineCare (Medicaid) and CubCare (Children’s Health Insurance Program) and will be sent to the Office for Family Independence for a final eligibility determination if anyone is likely to qualify for MaineCare or CubCare.  The Office for Family Independence will send you information about coverage and enrollment or contact you if they need more information.",
  "en.faa.anyone_found_eligible" => "If anyone in my application group is found eligible for MaineCare, I am authorizing the Office for Family Independence to pursue and get any money from other health insurance, legal settlements, or other third parties that may be legally responsible for paying for any health care received by me or members of my applicant group. I am also giving to the Office for Family Independence rights to pursue and get medical support from a spouse or parent.",
  "en.faa.parent_living_outside_of_home" => "<br><br>If yes, I know that, if anyone in my application group is found eligible for MaineCare, I will be asked to cooperate with the Child Support Agency to collect medical support from the parent who lives outside the home. If I think that cooperating to collect medical support will harm me or my children, I can tell my caseworker and I may not have to cooperate."
}.freeze
