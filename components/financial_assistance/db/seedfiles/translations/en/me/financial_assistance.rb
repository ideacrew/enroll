...
FINANCIAL_ASSISTANCE_TRANSLATIONS = {
  "en.faa.curam_lookup" => "It looks like you've already completed an application for Medicaid and cost savings
     on DC Health Link. Please call DC Health Link at (855) 532-5465 to make updates to that application.
  ...
  "en.faa.dhs_decision" => "<span>PLEASE NOTE: The Department of Health and Human Services (DHHS) will make a final decision on whether those listed qualify for <span class='run-glossary'>MaineCare or CubCare</span>.</span>
     They will send you a letter, and may ask you to provide documents. If you haven’t heard from DHHS within 45 days, you may wan to ask for an update by calling (855) 532-5465.",
