...
FINANCIAL_ASSISTANCE_TRANSLATIONS = {
  ...
  "en.faa.results.medicaid_or_chip_text" => "The people listed below may qualify for MaineCare Medicaid for reasons like age or disability. MaineCare provides free and low-cost health insurance to Maine residents who meet certain requirements. The Maine MaineCare Medicaid program will make a final decision on whether those listed qualify for MaineCare. While awaiting a decision they can enroll with financial assistance through CoverME.gov. If they are found eligible for MaineCare, they are no longer eligible for CoverME.gov coverage with financial assistance. They should return to CoverME.gov to end their coverage right away.",
