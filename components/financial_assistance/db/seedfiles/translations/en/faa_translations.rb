...
module FaaTranslations
  ...
  ELIGIBILITY_TRANSLATIONS = {
    ...
    "en.faa.eligible_for_medicaid" => "These people <span>appear to be eligible</span> for <%= render partial:'shared/glossary', locals: {key: 'medicaid', title: 'Medicaid', term: 'Medicaid' } %>",
    "en.faa.dhs_decision" =>
      "<span>PLEASE NOTE: The DC Department of Human Services (DHS) will make a final decision on whether those listed qualify for <%= render partial:'shared/glossary', locals: {key: 'medicaid', title: 'Medicaid', term: 'Medicaid' } %>.</span>",
    ...
    "en.faa.qualify_for_lower_costs_1" => "They also qualify for lower ",
    "en.faa.silver_plan_checkmark" => "- a benefit that lowers other costs like the annual deductible and copayments. This benefit is only available if these people select a silver plan. Look for this check mark ",
