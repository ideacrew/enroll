...
module FaaTranslations
  ...
  ELIGIBILITY_TRANSLATIONS = {
    ...
    "en.faa.eligible_for_medicaid" => "These people <span>appear to be eligible</span> for <span class='glossary-tooltips' tabindex='0' data-trigger='focus' data-title= 'Medicaid' data-placement='bottom' data-toggle='tooltip' data-html='true' title='<%= l10n('glossary.medicaid') %>'> Medicaid.</span>",
    "en.faa.dhs_decision" =>
    ...
    "en.faa.qualify_for_lower_costs_1" => "They also qualify for lower <span class='glossary-tooltips' tabindex='0' data-trigger='focus' data-placement='auto top' data-toggle='tooltip' data-html='true' title='<%= l10n('glossary.Out_of_Pocket_Costs') %>'> out-of-pocket costs</span> - a benefit that lowers other costs like the annual deductible and copayments. ",
