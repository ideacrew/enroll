...
module FaaTranslations
  ...
  ELIGIBILITY_TRANSLATIONS = {
    ...
    "en.faa.dhs_decision" => "<span>PLEASE NOTE: The DC Department of Human Services (DHS) will make a final decision on whether those listed qualify for </span>",
    ...
    "en.faa.likely_does_not_qualify_pt2" => ", </span> and don't qualify for private health insurance through DC Health Link:",
