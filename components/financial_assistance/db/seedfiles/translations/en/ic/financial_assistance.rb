...
FINANCIAL_ASSISTANCE_TRANSLATIONS = {
  ...
  "en.faa.results.csr_0_or_100_text" => "These people also qualify for lower out-of-pocket costs - a benefit that lowers other costs like the annual deductible and copayments. They also won’t pay anything for services they receive from an Indian Health Service provider.",
