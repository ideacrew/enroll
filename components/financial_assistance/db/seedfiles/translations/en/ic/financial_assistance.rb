...
FINANCIAL_ASSISTANCE_TRANSLATIONS = {
  ...
  "en.faa.does_not_qualify_text" => "These people likely don't qualify for Medicaid , and don't qualify for private health insurance through IdeaCrew.",
  ...
  "en.faa.send_to_external_verification" => "Send to OFI", # TODO: This is for State, we don't know what it should be for DC yet, if anything,
  ...
  "en.faa.results.medicaid_or_chip_text" => "These people appear to be eligible for Medicaid Medicaid or CHIP (the Children's Health Insurance Program):",
  ...
  "en.faa.results.non_magi_referral_text" => "These people may qualify for Medicaid for reasons like age or disability:",
  ...
  "en.faa.results.all_medicaid_next_steps_continue_text" => "Medicaid coverage is free. If you would like to enroll and pay full price for an insurance plan through %{short_name}",
