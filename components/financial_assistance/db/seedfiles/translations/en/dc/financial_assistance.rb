...
FINANCIAL_ASSISTANCE_TRANSLATIONS = {
  ...
  "en.faa.do_not_agree" => "If you do not agree with the determination, you have the right to appeal. <a href=\"<%= EnrollRegistry[:enroll_app].setting(:appeal_link).item %>\" target='_blank'>Find out more about the appeal process</a> or <a href=\"<%= EnrollRegistry[:enroll_app].setting(:find_expert_link).item %>\" target='_blank'>get help</a> by contacting us directly.",
