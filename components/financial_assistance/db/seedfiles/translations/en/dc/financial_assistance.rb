...
FINANCIAL_ASSISTANCE_TRANSLATIONS = {
  ...
  "en.faa.question.private_individual_and_family_coverage" => "DC Health Link Individual & Family coverage",
  ...
  "en.faa.question.coverage_obtained_through_another_exchange" => "Coverage obtained through a non-DC Health Link marketplace",
