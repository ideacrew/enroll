...
FINANCIAL_ASSISTANCE_TRANSLATIONS = {
  "en.faa.curam_lookup" => "It looks like you've already completed an application for Medicaid and cost savings on OPM.gov.
     Please call OPM.gov at (888) 813-9220 to make updates to that application.
      If you keep going, we'll check to see if you qualify to enroll in a private health insurance plan on OPM.gov, but won't be able to tell you if you qualify for Medicaid or cost savings.",
  "en.faa.acdes_lookup" => "It looks like you're already covered by Medicaid. Please call OPM.gov at (888) 813-9220 to make updates to your case.
     If you keep going, we'll check to see if you qualify to enroll in a private health insurance plan on OPM.gov, but won't be able to tell you if you qualify for Medicaid or cost savings.",
  ...
  "en.faa.dhs_contact" => "They will send you a letter, and may ask you to provide documents. If you haven’t heard from DHS within 45 days, you may want to ask for an update by calling OPM.gov at ",
  ...
  "en.faa.likely_does_not_qualify2" => "</span>, and don't qualify for private health insurance through OPM.gov:",
  ...
  "en.faa.next_step_with_aggregate_1" => "<b>NEXT STEP:</b><ul><li><b>If you’re already enrolled in OPM.gov’s Individual & Family plan</b>, we’ve automatically changed your premium. You don’t have to do anything else.</li>",
  ...
  "en.faa.eligibility_go_to_my_account_message" => "<b>If you’re already enrolled in OPM.gov’s Individual & Family plan</b>, you’re finished! To see your plan information, select <b>GO TO MY ACCOUNT</b>.",
