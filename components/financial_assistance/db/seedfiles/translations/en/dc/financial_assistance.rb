...
FINANCIAL_ASSISTANCE_TRANSLATIONS = {
  ...
  "en.faa.report_changes" => "I can report changes by going online and logging into 'My Account', by calling #{Settings.site.short_name}'s Contact Center toll free at '#{Settings.contact_center.phone_number}' TTY: 711, or by submitting information via mail or in-person at one of the Department of Human Services service centers.",
  ...
  "en.faa.i_understand_evaluation" => "",
  ...
  "en.faa.parent_living_outside_of_home" => ""
}.freeze
