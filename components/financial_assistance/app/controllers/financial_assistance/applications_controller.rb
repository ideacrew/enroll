...
module FinancialAssistance
  ...
  class ApplicationsController < FinancialAssistance::ApplicationController
    ...
    def index
      @applications = FinancialAssistance::Application.where("family_id" => get_current_person.financial_assistance_identifier).desc(:created_at)
      @filtered_applications = params.dig(:filter, :year).present? && !params[:filter][:year].nil? ? @applications.where(:assistance_year => params[:filter][:year]) : @applications
