...
module FinancialAssistance
  ...
  class ApplicantPolicy < Policy
    # Checks if the user can view and modify the index.
    #
    # @return [Boolean] Returns true if the user can view and modify the index, false otherwise.
    def index?
      modify_and_view?
    end
    ...
    def modify_and_view?
      ...
      consumer_policy.ridp_verified? && consumer_policy.modify_and_view?
    end
  end
end
