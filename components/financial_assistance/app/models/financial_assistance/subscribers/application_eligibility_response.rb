      ...
      def call(_event_name, _e_start, _e_end, _msg_id, payload)
        ...
        if stringed_key_payload['assistance_application_id'].present?
          ...
          if applications.count == 1
            ...
            log(xml, {:severity => 'critical', :error_message => "ERROR: Found #{applications.count} applications with given assistance_application_id: #{stringed_key_payload['assistance_application_id']}"})
            return
          end
        else
