    ...
    class SummaryService
      ...
      def initialize(is_concise, can_edit, cfl_service, application, applicants)
        ...
        @applicant_summaries = applicants.map do |applicant|
          is_concise ? Summary::ApplicantSummary::ConsumerApplicantSummary.new(cfl_service, application, applicant, can_edit: can_edit) : Summary::ApplicantSummary::AdminApplicantSummary.new(application, applicant)
        end
