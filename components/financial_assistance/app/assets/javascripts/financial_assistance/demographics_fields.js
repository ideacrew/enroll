...
function validationForIndianTribeMember() {
  ...
  $('form.new_applicant, form.edit_applicant').submit(function (e) {
    if (
      $('input[name="applicant[is_applying_coverage]"]').length > 0 &&
      $('input[name="applicant[is_applying_coverage]"]')
        .not(':checked')
        .val() == 'true'
    ) {
      return true;
...
var ApplicantValidations = (function (window, undefined) {
  ...
  function validationForUsCitizenOrUsNational(e) {
    ...
    if ($('input[name="applicant[us_citizen]"]').not(':checked').length == 2) {
      alert(
        'Please provide an answer for question: Are you a US Citizen or US National?'
      );
  ...
  function validationForIncarcerated(e) {
    ...
    if (
      $('input[name="applicant[is_incarcerated]"]').not(':checked').length == 2
    ) {
      alert(
        'Please provide an answer for question: Are you currently incarcerated?'
      );
      ApplicantValidations.restoreRequiredAttributes(e);
    }
  }
  ...
  function validationForNaturalizedCitizen(e) {
    ...
    if (
      ...
      $('input[name="applicant[naturalized_citizen]"]').not(':checked')
        .length == 2
    ) {
      alert(
        'Please provide an answer for question: Are you a naturalized citizen?'
      );
      ApplicantValidations.restoreRequiredAttributes(e);
    }
  }
  ...
  function validationForEligibleImmigrationStatuses(e) {
    if (
      ...
      $('input[name="applicant[eligible_immigration_status]"]').not(':checked')
        .length == 2 &&
