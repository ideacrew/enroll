    ...
    class BenefitSponsorsEmployerDatatable < Effective::MongoidDatatable
      ...
      datatable do
        ...
        table_column :actions, :width => '50px', :proc => Proc.new { |row|
          ...
          if employer_attestation_is_enabled?
            dropdown.insert(2,['Attestation', benefit_sponsors.edit_profiles_employers_employer_attestation_path(id: row.employer_profile.id, employer_actions_id: "employer_actions_#{@employer_profile.id}"), 'ajax'])
          end
