      ...
      datatable do
        ...
        table_column :actions, :width => '50px', :proc => Proc.new { |row|
          dropdown = [
              ...
              ['Send Secure Message', main_app.send_secure_message_form_path(profile_id: @employer_profile.id, employer_actions_id: "employer_actions_#{@employer_profile.id}"), pundit_allow(HbxProfile, :can_create_benefit_application?) ? 'ajax' : 'hide']
          ]
