    ...
    class CensusEmployeeObserver
      ...
      def notifications_send(model_instance, new_model_event)
        if new_model_event.present? &&  new_model_event.is_a?(BenefitSponsors::ModelEvents::ModelEvent)
          ...
          if BenefitSponsors::ModelEvents::CensusEmployee::OTHER_EVENTS.include?(new_model_event.event_key)
          ...
          if BenefitSponsors::ModelEvents::CensusEmployee::REGISTERED_EVENTS.include?(new_model_event.event_key)
