module BenefitSponsors
  module ApplicationHelper
    ...
    def add_plan_year_button_business_rule(benefit_applications)
      ...
      ineligible_rule_check = benefit_applications.enrollment_ineligible.effective_date_before_begin_on
      published_and_ineligible_apps = benefit_applications.published + benefit_applications.enrollment_ineligible
      ((published_and_ineligible_apps - ineligible_rule_check).blank? || canceled_rule_check) && benefit_applications.none?(&:is_renewing_and_non_ineligible?)
    end
