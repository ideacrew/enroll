module BenefitSponsors
  module ApplicationHelper
    ...
    def add_plan_year_button_business_rule(benefit_applications)
      ...
      ineligible_rule_check = benefit_applications.enrollment_ineligible.future_effective_date
      ((benefit_applications.published - ineligible_rule_check).blank? || canceled_rule_check) && benefit_applications.none?(&:is_renewing_and_non_ineligible?)
    end
