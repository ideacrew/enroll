      ...
      class BrokerAgencyProfilesController < ::BenefitSponsors::ApplicationController
        ...
        def user_not_authorized(exception)
          if exception.query == :redirect_signup?
            ...
            current_user.has_broker_agency_staff_role? ? redirect_to profiles_broker_agencies_broker_agency_profile_path(
              :id => current_user.person.broker_agency_staff_roles.first.benefit_sponsors_broker_agency_profile_id
