module BenefitSponsors
  class ApplicationController < ActionController::Base
    ...
    def broker_agency_and_general_agency?
      @profile_type == "broker_agency" || "general_agency"
    end

    def user_not_authorized(exception)
      policy_name = exception.policy.class.to_s.underscore

      flash[:error] = "Access not allowed for #{exception.query}, (Pundit policy)" unless broker_agency_and_general_agency?
