...
module BenefitSponsors
  ...
  # For the time being there is no way to pass the GHAs without pulling from the BenefitSponsors::ApplicationPolicy
  # All "building blocks" have been selected from existing methods in the main app ApplicationPolicy for ease of transition
