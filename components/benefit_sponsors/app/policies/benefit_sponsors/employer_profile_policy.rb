module BenefitSponsors
  class EmployerProfilePolicy < ApplicationPolicy
    ...
    def show?
      ...
      return true if user.has_hbx_staff_role? || is_broker_for_employer?(record) || is_general_agency_staff_for_employer?(record) || is_broker_staff_role_for_employer?(record)
