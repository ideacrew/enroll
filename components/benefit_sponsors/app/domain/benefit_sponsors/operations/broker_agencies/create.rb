    ...
    module BrokerAgencies
      ...
      class Create
        ...
        def call(params)
          ...
          _staff_role_status, redirection_link = yield create_broker_role(sanitized_params[:staff_roles], validated_params[:person_id])
        ...
        def build_profile(profile_attrs)
          result = BenefitSponsors::Operations::Profiles::Build.new.call(profile_type: 'broker_agency', profile_attrs: profile_attrs)
          if result.success?
            result
          else
        ...
        def build_organization(organization_attrs, profile_entity)
          ...
          result = BenefitSponsors::Operations::Organizations::Build.new.call(profile_type: 'broker_agency', organization_attrs: org_attrs)
          if result.success?
            result
          else
        ...
        def create_profile(organization, profile_entity)
          profile = BenefitSponsors::Organizations::BrokerAgencyProfile.new(profile_entity.to_h)
