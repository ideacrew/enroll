    ...
    module GeneralAgencies
      ...
      class New
        ...
        def validate(params)
          ...
          elsif !%w[general_agency].include?(params[:profile_type])
        ...
        def construct_profile_params
          profile = BenefitSponsors::Entities::Profiles::BrokerAgencyProfile.to_hash(BenefitSponsors::Organizations::GeneralAgencyProfile.new)
