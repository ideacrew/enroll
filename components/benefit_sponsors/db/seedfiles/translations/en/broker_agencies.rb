BROKER_AGENCIES_TRANSLATIONS = {
  ...
  "en.broker_agency_information" => "Broker Agency Staff",
  ...
  "en.npn_error" => "Please provide an NPN.",
	...
	"en.general_agency_staff" => "General Agency Staff",
	"en.select_your_general_agency" => "Select Your General Agency",
	"en.primary_general_agency_staff_name" => "Primary GA Name",
	"en.general_agencies.profiles.select_this_general_agency" => "Select this Agency",
