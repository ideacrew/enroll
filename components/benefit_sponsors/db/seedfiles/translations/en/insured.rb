...
INSURED_TRANSLATIONS = {
  ...
  "en.insured.consumer_roles.docs_shared.certificate_number" => "Certificate Number",
  "en.insured.consumer_roles.docs_shared.certificate_number_title" => "• When entering a Citizenship Certification Number, include all numbers and letters. Do not enter any other characters or spaces. • The Certification number entered must have between 6 and 12 characters. \
