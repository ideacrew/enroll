EMPLOYER_TRANSLATIONS = {
  ...
  "en.employers.file_upload_success.subject" => "employees created from file upload",
  "en.employers.file_upload_success.body" => "%{employees_count} employees created successfully",
  "en.employers.file_upload_error.subject" => "employees are not created",
  "en.employers.file_upload_success.body" => "Employees are not created"
}
