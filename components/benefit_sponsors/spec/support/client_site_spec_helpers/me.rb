module BenefitSponsors
  module ClientSiteSpecHelpers
    ...
    def self.create_site_with_hbx_profile_and_empty_benefit_market(market_kind = :aca_shop)
      site = create_site_with_hbx_profile
    ...
    def self.create_shop_benefit_market(site_id)
      ...
      b_market_props = {
        _id: b_market_id, title: "ACA SHOP", description: "CCA ACA Shop Market", kind: :aca_shop, site_urn: "cca", site_id: site_id,
        configuration: {
          _id: config_id,
          ...
          initial_application_configuration: { _id: initial_app_config_id, pub_due_dom: 15, erlst_strt_prior_eff_months: -2, appeal_per_aft_app_denial_dys: 30, quiet_per_end: 28, inelig_per_aft_app_denial_dys: 90 },
          renewal_application_configuration: { _id: renewal_app_config_id, erlst_strt_prior_eff_months: -2, montly_oe_end: 20, pub_due_dom: 15, force_pub_dom: 16, oe_min_dys: 5, quiet_per_end: 15
          }
        }
      }
    ...
    def self.create_site_with_hbx_profile
      ...
      site_props = { _id: site_id, site_key: :cca, byline: "The Right Place for the Right Plan", short_name: "Access Health", domain_name: "hbxshop.org", long_name: "Maine Cover ME", copyright_period_start: '2018' }
      org_props = {
        _id: org_id,
        _type: "BenefitSponsors::Organizations::ExemptOrganization", dba: "CCA", fein: '123123456', hbx_id: '210005', legal_name: "Access Health", site_id: site_id,
        profiles: [{
          _id: profile_id,
          ...
          office_locations: [{
            ...
            is_primary: true,
            address: { _id: address_id, address_1: "1225 I St, NW", kind: "work", city: "Washington", state: "MA", zip: '20002'},
            phone: { _id: phone_id, kind: "main", area_code: '855', number: '5325465', full_phone_number: '8555325465'}
          }],
          inbox: { _id: inbox_id }
        }],
