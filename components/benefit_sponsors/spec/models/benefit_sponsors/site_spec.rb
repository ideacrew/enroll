...
module BenefitSponsors
  RSpec.describe Site, type: :model, dbclean: :after_each do
    ...
    let(:profile)             { FactoryBot.build(:benefit_sponsors_organizations_hbx_profile) }
    ...
    context "organization associations must be valid" do
      ...
      let!(:site)               { FactoryBot.create(:benefit_sponsors_site, :owner_organization => owner_organization, site_organizations: [ owner_organization ]) }
      ...
      context "and benefit_market associations must be valid" do
        ...
        context "benefit_market should be findable by kind" do
          ...
          let(:shop_only_site)        { FactoryBot.build(:benefit_sponsors_site, :owner_organization => owner_organization_1, site_organizations: [ owner_organization_1 ], benefit_markets: [shop_benefit_market_1]) }
          let(:ivl_only_site)         { FactoryBot.build(:benefit_sponsors_site, :owner_organization => owner_organization_2, site_organizations: [ owner_organization_2 ], benefit_markets: [ivl_benefit_market_1]) }
          let(:shop_and_ivl_site)     { FactoryBot.build(:benefit_sponsors_site, :owner_organization => owner_organization_3, site_organizations: [ owner_organization_3 ], benefit_markets: [ivl_benefit_market_2, shop_benefit_market_2]) }
