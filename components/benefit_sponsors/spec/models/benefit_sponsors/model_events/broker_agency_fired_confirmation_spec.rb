...
RSpec.describe 'BenefitSponsors::ModelEvents::BrokerAgencyFiredConfirmation', dbclean: :around_each  do
  ...
  describe "when ER fires a broker_agency" do
    context "NoticeTrigger" do
      ...
      it "should trigger notice event" do
        ...
        subject.notifier.deliver(recipient: broker_agency_profile, event_object: employer_profile, notice_event: notice_event)
      end
    end
  end
  ...
  describe "NoticeBuilder" do
    ...
    it "should return broker termination date" do
      expect(merge_model.termination_date).to eq model_instance.end_on
    end
