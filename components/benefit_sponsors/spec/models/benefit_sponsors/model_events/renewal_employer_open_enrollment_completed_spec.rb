...
RSpec.describe 'BenefitSponsors::ModelEvents::RenewalEmployerOpenEnrollmentCompleted', dbclean: :after_each do
  ...
  let(:renewal_benefit_group_assignment) { FactoryBot.create(:benefit_group_assignment, benefit_group_id: nil, benefit_package_id: benefit_package.id, is_active: false, census_employee: census_employee, start_on: benefit_package.start_on, end_on: benefit_package.end_on) }
  let!(:current_benefit_group_assignment) { FactoryBot.create(:benefit_group_assignment, benefit_group_id: nil, benefit_package_id: current_benefit_package.id, is_active: true, census_employee: census_employee, start_on: current_benefit_package.start_on, end_on: current_benefit_package.end_on) }
