module Notifier
  class ApplicationEventMapper
    ...
    RESOURCE_MAP = {
      "BenefitSponsors::Organizations::#{EnrollRegistry[:enroll_app].setting(:site_key).item.capitalize}ShopEmployerProfile" => Resource.new(:employer, :hbx_id, :employer_id, :by_hbx_id),
