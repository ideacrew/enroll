  ...
  factory :benefit_sponsors_benefit_sponsorship, class: 'BenefitSponsors::BenefitSponsorships::BenefitSponsorship' do
    ...
    trait :with_full_package do
      after :build do |benefit_sponsorship, evaluator|
        ...
        # profile { FactoryGirl.build(:benefit_sponsors_organizations_aca_shop_cca_employer_profile, :with_organization_and_site) }
        ...
        benefit_sponsorship = profile.add_benefit_sponsorship
        benefit_sponsorship.rating_area = benefit_sponsorship.primary_office_rating_area
      end
    end
    ...
    trait :with_market_profile do
      ...
      before(:create) do |benefit_sponsorship, evaluator|
        # benefit_sponsorship.organization = FactoryGirl.build(:benefit_sponsors_organizations_general_organization)
        # benefit_sponsorship.benefit_market = ::BenefitMarkets::BenefitMarket.new(kind: :aca_shop, title: "DC Health SHOP", site_urn: :dc)
        # benefit_sponsorship.profile = FactoryGirl.build(:benefit_sponsors_organizations_aca_shop_dc_employer_profile)
