...
RSpec.describe BenefitSponsors::Validators::Profiles::ProfileContract do
  ...
  describe "Given valid parameters" do
    let(:valid_params) { params.merge({contact_method: :electronic_only})}
