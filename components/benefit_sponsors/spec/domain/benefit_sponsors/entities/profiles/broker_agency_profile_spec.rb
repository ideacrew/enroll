...
RSpec.describe BenefitSponsors::Entities::Profiles::BrokerAgencyProfile do

  context "Given valid required parameters" do

    let(:contract)      { BenefitSponsors::Validators::Profiles::BrokerAgencyProfileContract.new }
    ...
    context "with required only" do
      ...
      it "should create new Organization instance" do
        expect(described_class.new(params)).to be_a BenefitSponsors::Entities::Profiles::BrokerAgencyProfile
      end
    end
  end
end