...
RSpec.describe BenefitSponsors::Entities::Profiles::GeneralAgencyProfile do

  context "Given valid required parameters" do

    let(:contract)      { BenefitSponsors::Validators::Profiles::GeneralAgencyProfileContract.new }
    ...
    context "with required only" do
      ...
      it "should create new Organization instance" do
        expect(described_class.new(params)).to be_a BenefitSponsors::Entities::Profiles::GeneralAgencyProfile
      end
    end
  end
end