...
RSpec.describe BenefitSponsors::Operations::GeneralAgencies::New, dbclean: :after_each do
  ...
  describe '#call' do
    ...
    context 'when person id is not passed' do
      let(:params)  { {profile_type: 'general_agency'} }
    ...
    context 'when person id is passed' do
      let(:params)  { {profile_type: 'general_agency', person_id: person.id.to_s} }
