...
# RAILS_ENV=production bundle exec rake migrations:modify_benefit_application fein=531828 termination_date="12/01/2016" end_on="12/01/2016" action="terminate" termination_notice="true" notify_trading_partner="true", termination_kind='voluntary/non-payment', termination_reason = "Company went out of business/bankrupt"
