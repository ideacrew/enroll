...
INSURED_TRANSLATIONS = {
  ...
  "en.DCHL" => "DCHL",
  "en.DCHL_ID" => "DCHL ID",
  "en.confirmation" => "Cancel Plan",
  "en.insured.group_selection.terminate_confirm.terminate_this_plan_do_you_wish_proceed" => "Do you want to cancel this plan? Cancelling means you will no longer have insurance. You will not be able to enroll in a new plan unless it’s open enrollment or you qualify for a special enrollment period.",
