    ...
    private
      ...
      def set_broker_agency_profile_from_user
        ...
        if current_person.broker_role.present?
          @broker_agency_profile = ::BenefitSponsors::Organizations::Profile.where(id: current_person.broker_role.benefit_sponsors_broker_agency_profile_id).first
          ...
          @broker_agency_profile = ::BenefitSponsors::Organizations::Profile.where(id: params[:plan_design_organization_id]).first
          ...
          unless current_uri.include? 'broker_agency_profile'
            ...
            @broker_agency_profile = ::BenefitSponsors::Organizations::Profile.where(id: org.owner_profile_id).first
            @broker_agency_profile ||= ::BrokerAgencyProfile.find(org.owner_profile_id) # Deprecate this
          end
        end
      end
