  ...
  class Organizations::PlanDesignProposalsController < ApplicationController
    ...
    def claim
      ...
      unless claim_code_status == "invalid"
        ...
        employer_osse_eligible = employer_profile.active_benefit_sponsorship&.eligibility_for("aca_shop_osse_eligibility_#{effective_on.year}".to_sym, effective_on).present?
