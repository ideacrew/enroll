...
RSpec.describe Subscribers::BenefitSponsors::EmployeeRoleSubscriber,
               type: :model,
  ...
  let(:payload) do
    {
      employee_role_global_id: valid_employee_role.to_global_id.to_s
    }.to_json
  end
  ...
  let(:subscribe_operation) do
    ...
    connection_manager.find_subscribe_operation({
                                                  protocol: :amqp,
                                                  subscribe_operation_name: "on_enroll.enroll.benefit_sponsors.employee_role"
                                                })
  end
  ...
  before do
    ...
    valid_employee_role.census_employee_id = initial_census_employee.id
    valid_employee_role.person.save
  end
