...
RSpec.describe UserMailer do
  ...
  describe 'tax_form_notice_alert' do
    ...
    let(:email_body) { l10n('user_mailer.tax_form_notice_alert.full_text', first_name: 'John', site_short_name: site_short_name,  contact_center_phone_number: contact_center_short_phone_number, site_home_business_url: site_home_business_url) }
