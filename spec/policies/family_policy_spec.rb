...
describe FamilyPolicy, "given a family with an active broker agency account" do
  ...
  let(:broker_person) { instance_double(Person, :id => broker_person_id, :broker_role => broker_role, :active_general_agency_staff_roles => []) }
...
describe FamilyPolicy, "given a family where the primary has an active employer general agency account account" do
  ...
  let(:ga_person) { instance_double(Person, :id => ga_person_id, :broker_role => nil, :active_general_agency_staff_roles => [general_agency_staff_role]) }
