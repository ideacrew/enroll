...
describe UpdateCarrierAppointments do
  ...
  describe "migrating old pending broker records" do
    before do
    @broker_role = FactoryGirl.create(:broker_role, carrier_appointments: { "altus_dental" => nil,
                                                                            "blue_cross_blue_shield_of_mA" => nil,
                                                                            "boston_medical_center_health_planc" => nil,
                                                                            "delta_dental" => nil,
                                                                            "FCHP" => nil,
                                                                            "guardian" => nil,
                                                                            "health_new_england" => nil,
                                                                            "harvard_pilgrim_health_car" => nil,
                                                                            "minuteman_health" => nil,
                                                                            "neighborhood_health_plan" => nil,
                                                                            "tufts_health_plan_direct" => nil,
                                                                            "tufts_health_plan_premier" => nil}) 
      @value = {"Altus Dental" => nil,
