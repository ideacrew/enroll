...
describe RemoveDecertifiedBrokersAssignments do
  ...
  let(:fam_broker_agency_account) {BenefitSponsors::Accounts::BrokerAgencyAccount.new(start_on: TimeKeeper.date_of_record,benefit_sponsors_broker_agency_profile_id: broker_agency_profile.id,is_active: true, writing_agent_id: broker_role.id)}
