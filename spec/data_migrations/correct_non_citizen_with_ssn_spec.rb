    ...
    context "ssn response true" do
      describe "citizenship true" do
        ...
        it "stores citizenship_result if citizenship successful" do
          expect(person.consumer_role.lawful_presence_determination.citizenship_result).to eq "non_native_citizen"
        end
      end
      ...
      describe "citizenship false" do
        ...
        it "moves person to dhs_pending" do
          expect(person.consumer_role.aasm_state).to eq "dhs_pending"
        end

        it "stores partial transition information" do
          expect(person.consumer_role.lawful_presence_determination.citizen_status).to eq "non_native_not_lawfully_present_in_us"
          expect(person.consumer_role.lawful_presence_determination.citizenship_result).to eq "ssn_pass_citizenship_fails_with_SSA"
        end
      end
    end
