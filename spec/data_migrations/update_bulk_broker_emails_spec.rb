...
describe "Update Broker Emails", dbclean: :after_all do
  ...
  describe "spec for bulk broker email updates" do
    ...
    before do
      allow_any_instance_of(UpdateBulkBrokerEmails).to receive(:broker_csv).and_return(
        File.read("#{Rails.root}/spec/support/update_bulk_broker_emails_2021_10_5.csv")
      )
