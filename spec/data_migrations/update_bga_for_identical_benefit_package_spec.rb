...
describe UpdateBgaForIdenticalBenefitPackage, dbclean: :around_each do
  ...
  describe "update benefit group assignment for identical benefit package" do
    ...
    before(:each) do
      census_employee.benefit_group_assignments.build(benefit_group: second_benefit_package, start_on: second_benefit_package.start_on, is_active: false, hbx_enrollment_id: enrollment.id)
