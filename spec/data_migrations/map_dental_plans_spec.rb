...
describe MapDentalPlans do
  ...
  describe "update the previous year renewal plan_id" do
    ...
    let(:previous_year_plan){ FactoryGirl.create(:plan, active_year: "2016", hios_id: "14171AB0010203", coverage_kind: "dental", dental_level: "low") }
    let(:current_year_plan){ FactoryGirl.create(:plan, active_year: "2017", hios_id: "14171AB0010203", coverage_kind: "dental", dental_level: "low") }
