...
describe CorrectBenefitGroupAssignmentDates do

  let(:given_task_name) { "correct_benefit_group_assignment_dates" }
  subject { CorrectBenefitGroupAssignmentDates.new(given_task_name, double(:current_scope => nil)) }
