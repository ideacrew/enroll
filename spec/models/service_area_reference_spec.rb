...
RSpec.describe ServiceAreaReference, type: :model do
  ...
  it { is_expected.to validate_presence_of :covers_entire_state }

  context "covers_entire_state is false" do
    subject { build(:service_area_reference, covers_entire_state: false) }
    ...
    context "serves_partial_county is true" do
      subject { build(:service_area_reference, covers_entire_state: false, serves_partial_county: true) }
