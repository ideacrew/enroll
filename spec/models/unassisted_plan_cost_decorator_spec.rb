...
RSpec.describe UnassistedPlanCostDecorator, dbclean: :after_each do
  ...
  describe 'UnassistedPlanCostDecorator' do
    ...
    let!(:hbx_enrollment10) { FactoryBot.create(:hbx_enrollment, family: family10, household: family10.active_household, aasm_state: 'shopping', product: product, effective_on: Date.today.beginning_of_year) }
