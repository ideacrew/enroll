...
describe 'ModelEvents::GroupNonPaymentTerminationNotice', dbclean: :around_each do
  ...
  describe "NoticeBuilder" do
    ...
    context "when notice event notify_employer_of_group_non_payment_termination is received" do
    ...
    context "when notice event notify_employee_of_group_non_payment_termination is received" do
      let(:data_elements) {
        [
