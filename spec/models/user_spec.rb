...
RSpec.describe User, :type => :model do
  ...
  describe 'user' do
    ...
    context 'when email' do
      ...
      it 'is invalid' do
        expect(User.create(**params).errors[:email].any?).to be_true
    ...
    context 'when password' do
      ...
      it 'is empty' do
        expect(User.create(**params).errors[:password].any?).to be_true
    ...
    context 'when password & password confirmation' do
      ...
      it 'does not match' do
        expect(User.create(**params).errors[:password].any?).to be_true
        expect(User.create(**params).errors[:password_confirmation].any?).to be_true
    ...
    context 'when associated person' do
      ...
      it 'first name is invalid' do
        ...
        expect(User.create(**params).errors[:person].any?).to be_true
        expect(User.create(**params).errors[:person]).to eq ["is invalid"]
        expect(User.create(**params).person.errors[:first_name].any?).to be_true
      ...
      it 'last name is invalid' do
        ...
        expect(User.create(**params).errors[:person].any?).to be_true
        expect(User.create(**params).errors[:person]).to eq ["is invalid"]
        expect(User.create(**params).person.errors[:last_name].any?).to be_true
      ...
      it 'ssn is invalid' do
        ...
        expect(User.create(**params).errors[:person].any?).to be_true
        expect(User.create(**params).errors[:person]).to eq ["is invalid"]
        expect(User.create(**params).person.errors[:ssn].any?).to be_true
