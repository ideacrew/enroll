...
describe HbxEnrollment,"reinstate and change end date", type: :model, :dbclean => :around_each do
  ...
  context "reinstate aptc enrollment" do
    ...
    before :each do
      ...
      @product.save!
      enrollment.update_attributes(product: @product, effective_on: Date.new(effective_on.year, 1, 1), aasm_state: "coverage_terminated", terminated_on: Date.new(effective_on.year,5,31))
