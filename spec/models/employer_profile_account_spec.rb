  ...
  context ".new" do
    ...
    context "with all valid parameters" do
      ...
      context "and it is saved" do
        ...
        #     TimeKeeper.set_date_of_record_unprotected!(open_enrollment_end_on + 1.day)
        #     TimeKeeper.instance.push_date_of_record
        #     employer_profile.advance_day
        #   end

        #   it "employer profile and plan year should reflect enrollment is valid and complete" do
        #     expect(employer_profile.plan_year.aasm_state).to eq "enrolled"
        #     expect(employer_profile.aasm_state).to eq "eligible"
        #   end
