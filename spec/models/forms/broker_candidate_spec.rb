...
describe Forms::BrokerCandidate do
  ...
  describe ".save" do
    ...
    context 'when multiple people matched with the entered personal information' do
      ...
      it 'should raise an error' do
        expect(subject.errors.to_hash[:base]).to include("too many people match the criteria provided for your identity.  Please contact HBX-Customer Service - Call (888) 813-9220.")
      end
    end
