  ...
  describe "class method" do
    ...
    context "individual_plans" do
      ...
      it "should return health plans" do
        ...
        expect(Plan.individual_plans(coverage_kind: 'health', active_year: TimeKeeper.date_of_record.year, tax_households: [tax_household], family_member_ids: nil).to_a).to eq []
      end
