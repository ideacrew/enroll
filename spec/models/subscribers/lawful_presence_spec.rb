...
describe Subscribers::LawfulPresence do
  ...
  describe "given a ssa verification message to handle" do
    ...
    let(:xml_hash) { {:case_number=>"12121", :lawful_presence_determination =>{
        :response_code=>"not_lawfully_present", :legal_status=>"lawful_permanent_resident",
        :employment_authorized=>"authorized", :document_results=>{:document_cert_of_naturalization=>{
            :case_number=>"2113123", :response_code=>"022", :response_description_text=>"Good",
            :tds_response_description_text=>nil, :entry_date=>nil, :admitted_to_date=>nil, :admitted_to_text=>nil,
            :country_birth_code=>nil, :country_citizen_code=>nil, :coa_code=>nil, :eads_expire_date=>nil,
            :elig_statement_code=>"011", :elig_statement_txt=>"ok", :iav_type_code=>nil, :iav_type_text=>nil,
            :grant_date=>nil, :grant_date_reason_code=>nil}, :document_foreign_passport=>{
            :case_number=>"12123123", :response_code=>"011", :response_description_text=>"Valid Passport",
            :tds_response_description_text=>nil, :entry_date=>nil, :admitted_to_date=>nil, :admitted_to_text=>nil,
            :country_birth_code=>nil, :country_citizen_code=>nil, :coa_code=>nil, :eads_expire_date=>nil,
            :elig_statement_code=>"01", :elig_statement_txt=>"1.1", :iav_type_code=>nil, :iav_type_text=>nil,
            :grant_date=>nil, :grant_date_reason_code=>nil}}}} }
