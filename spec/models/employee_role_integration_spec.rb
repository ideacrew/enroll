            ...
            context "and a new employee role is created" do
              ...
              context "and the employee is assigned to both benefit groups" do
                ...
                context "and the first plan year is published" do
                  before do
                    RateReference.find_or_create_by(county_name: organization.primary_office_location.address.county, zip_code: organization.primary_office_location.address.zip, rating_area: "R-MA001" )
                    plan_year_a.publish!
                  end
