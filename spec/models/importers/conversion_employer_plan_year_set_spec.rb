...
describe ::Importers::ConversionEmployerPlanYearSet, dbclean: :around_each do
  ...
  describe "provided a file in xlsx format" do
    ...
    let(:base_output_result) do
      "Action,FEIN,Doing Business As,Legal Name,Physical Address 1,Physical Address 2,City,State,Zip,County,Mailing Address 1,Mailing Address 2,City,State,Zip," \
        "Contact First Name,Contact Last Name,Contact Email,Contact Phone,Enrolled Employee Count,New Hire Coverage Policy,Contact Address 1,Contact Address 2,City,State,Zip," \
        "Broker Name,Broker NPN,TPA Name,TPA FEIN,Coverage Start Date,Carrier Selected,Plan Selection Category,Plan Name,Plan HIOS Id,Most Enrollees - Plan Name," \
        "Most Enrollees - Plan HIOS Id,Reference Plan - Name,Reference Plan - HIOS Id,Employer Contribution -  Employee,Employer Contribution - Spouse,Employer Contribution - Domestic Partner," \
        "Employer Contribution - Child under 26,Employer Contribution - Child over 26,Employer Contribution - Disabled child over 26,Import Status,Import Details\n" \
        "Add,931100000,AGA DBA,AGA LEGAL,799 9TH STREET NW,7TH FLR,Washington,DC,20001,County,\"\",\"\",\"\",\"\",\"\",THE,CONTACT,THECONTACT@AGA.COM,2025552675," \
        "14,Date of Hire equal to Effective Date,799 9TH STREET NW,7TH FLR,Washington,DC,20001,THE BROKER   ,8262800  ,\"\",\"\",07/01/2016,United Healtcare," \
        "Single Plan from Carrier,Choice Plus Insurance/0/5000,41842DC0010068-01,\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\""
    end
