...
describe ::Importers::ConversionEmployerSet do
  ...
  describe "provided a file in xlsx format" do
    ...
    let(:employer_data) do
      {:action=>"Add",
       :fein=>"931100000",
       :dba=>"AGA DBA",
       :legal_name=>"AGA LEGAL",
       :primary_location_address_1=>"799 9TH STREET NW",
       :primary_location_address_2=>"7TH FLR",
       :primary_location_city=>"Washington",
       :primary_location_state=>"DC",
       :primary_location_zip=>"20001",
       :contact_email=>"THECONTACT@AGA.COM",
       :contact_phone=>"2025552675",
       :enrolled_employee_count=>"14",
       :new_hire_count=>"Date of Hire equal to Effective Date",
  ...
  describe "provided a file in csv format" do
    ...
    let(:employer_data) do
      {:action=>"Add", :fein=>"521782000", :dba=>"MCP DBA", :legal_name=>"MCP LEGAL", :primary_location_address_1=>"3001 P Street N.W.", :primary_location_city=>"Washington", :primary_location_state=>"DC", :primary_location_zip=>"20007", :mailing_location_address_1=>"3001 P Street N.W.", :mailing_location_city=>"Washington", :mailing_location_state=>"DC", :mailing_location_zip=>"20007", :contact_email=>"thecontact@mcp.com", :contact_phone=>"2025554100", :enrolled_employee_count=>"3", :broker_name=>"The Broker", :broker_npn=>"629000"}
    end
