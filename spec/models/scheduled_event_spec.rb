...
RSpec.describe ScheduledEvent, type: :model, dbclean: :after_each do
  ...
  context "Calendar Event" do
    ...
    it "should reschedule to Monday for Sunday scheduled Event with offset 1" do
      sunday_offset_1.update_attributes(recurring_rules: "{\"interval\":1,\"until\":null,\"count\":null,\"validations\":{\"day_of_week\":{},\"day_of_month\":[#{TimeKeeper.date_of_record.sunday.day}]},\"rule_type\":\"IceCube::MonthlyRule\",\"week_start\":0}")
    ...
    it "should reschedule to Thursday for Saturday scheduled Event with offset 4" do
      saturday_offset_1.update_attributes(recurring_rules: "{\"interval\":1,\"until\":null,\"count\":null,\"validations\":{\"day_of_week\":{},\"day_of_month\":[#{(TimeKeeper.date_of_record.sunday + 6.day).day}]},\"rule_type\":\"IceCube::MonthlyRule\",\"week_start\":0}")
