...
RSpec.describe Factories::FamilyEnrollmentCloneFactory, :type => :model, dbclean: :after_each do
  ...
  let!(:active_benefit_group_assignment) { FactoryBot.build(:benefit_group_assignment, benefit_package: sponsored_benefit_package, start_on: sponsored_benefit_package.start_on, end_on: sponsored_benefit_package.end_on)}
