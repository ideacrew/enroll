...
RSpec.describe "employers/employer_profiles/_show_profile" do
  ...
  it "should display the Profile tab" do
    @tab = 'profile'
  ...
  it "should display the Benefits tab" do
    @tab = 'benefits'
    render "employers/employer_profiles/show_profile"
  ...
  it "should display the Employees Tab" do
    @tab = 'employees'
  ...
  it "should display the Broker Agency Tab" do
    @tab = 'broker_agency'
    stub_template "employers/broker_agency/_active_broker" => ''
    render "employers/employer_profiles/show_profile"
  ...
  it "should display the Documents tab" do
    @tab = 'documents'
    render "employers/employer_profiles/show_profile"
  ...
  it "should display the Families Tab" do
    @tab = 'families'
    @employees = []
    render "employers/employer_profiles/show_profile"
    expect(rendered).to_not match(/#{@employer_profile.legal_name}/)
