...
RSpec.describe "shared/plan_shoppings/_sbc_link.html.erb" do
  ...
  it "should have the sbc link" do
    expect(rendered).to have_selector("a[href='#{root_path + "document/download/#{Settings.site.s3_prefix}-enroll-sbc-#{aws_env}/7816ce0f-a138-42d5-89c5-25c5a3408b82?content_type=application/pdf&filename=APlanName.pdf&disposition=inline"}']")
  end
