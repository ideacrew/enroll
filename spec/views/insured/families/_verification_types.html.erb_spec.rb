...
describe "app/views/insured/families/verification/_verification_types.html.erb" do
  ...
  before do
    ...
    render :partial => 'insured/families/verification/verification_types.html.erb', :locals => { :member => family.family_members.first}
  end
