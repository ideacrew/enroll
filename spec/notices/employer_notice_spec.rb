...
#         expect{ShopNotices::EmployerNotice.new(employer_profile, valid_parmas)}.not_to raise_error
#       end
#     end
...
#           expect{ShopNotices::EmployerNotice.new(employer_profile, valid_parmas)}.to raise_error(RuntimeError,"Required params #{key} not present")
#         end
#       end
#     end
#   end
...
#     before do
#       allow(employer_profile).to receive_message_chain("staff_roles.first").and_return(person)
#       @employer_notice = ShopNotices::EmployerNotice.new(employer_profile, valid_parmas)
#     end
