...
RSpec.describe IvlNotices::EnrollmentNoticeBuilderWithDateRange, dbclean: :after_each do
  ...
  let!(:hbx_enrollment) {FactoryBot.create(:hbx_enrollment, family: family, created_at: (TimeKeeper.date_of_record.in_time_zone("Eastern Time (US & Canada)") - 2.days), household: family.households.first, kind: "individual", aasm_state: "enrolled_contingent")}
