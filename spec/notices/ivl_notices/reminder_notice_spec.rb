...
RSpec.describe IvlNotices::ReminderNotice, :dbclean => :after_each do
  ...
  let!(:hbx_enrollment) {FactoryGirl.create(:hbx_enrollment, hbx_enrollment_members: [hbx_enrollment_member], household: family.active_household, kind: "individual", is_any_enrollment_member_outstanding: true, effective_on: TimeKeeper.date_of_record, aasm_state: "coverage_selected")}
