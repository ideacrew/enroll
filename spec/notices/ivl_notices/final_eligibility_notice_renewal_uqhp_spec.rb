...
RSpec.describe IvlNotices::FinalEligibilityNoticeRenewalUqhp, :dbclean => :after_each do
  ...
  let!(:hbx_enrollment_1) {FactoryBot.create(:hbx_enrollment, family: family, household: family.households.first, kind: "individual", plan: plan, aasm_state: "enrolled_contingent", special_verification_period: TimeKeeper.date_of_record+95.days, effective_on: Date.new(TimeKeeper.date_of_record.year,1,1))}
