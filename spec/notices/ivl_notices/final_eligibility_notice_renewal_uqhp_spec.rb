...
if ExchangeTestingConfigurationHelper.individual_market_is_enabled?
  RSpec.describe "FinalEligibilityNoticeRenewalUqhp", :dbclean => :after_each do
    ...
    let!(:input_file) { Rails.root.join("spec", "test_data", "notices", "ivl_fre_uqhp_test_data.csv") }
    ...
    describe "NoticeBuilder" do
      ...
      context "when notice event received" do
        ...
        it "should return if documents needed" do
          expect(merge_model.documents_needed).to eq false
        end
        ...
        it "should return if any unverified individuals present or not" do
          ...
          expect(merge_model.income_unverified_individuals_present).to eq false
