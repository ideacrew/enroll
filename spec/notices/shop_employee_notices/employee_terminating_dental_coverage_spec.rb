...
RSpec.describe ShopEmployeeNotices::EmployeeTerminatingDentalCoverage, :dbclean => :after_each do
...
describe "New" do
    before do
      ...
      @employee_notice = ShopEmployeeNotices::EmployeeTerminatingDentalCoverage.new(census_employee, valid_params)
    end
    context "valid params" do
      it "should initialze" do
        expect{ShopEmployeeNotices::EmployeeTerminatingDentalCoverage.new(census_employee, valid_params)}.not_to raise_error
      end
    end
    ...
    context "invalid params" do
      [:mpi_indicator,:subject,:template].each do  |key|
        it "should NOT initialze with out #{key}" do
          ...
          expect{ShopEmployeeNotices::EmployeeTerminatingDentalCoverage.new(census_employee, valid_params)}.to raise_error(RuntimeError,"Required params #{key} not present")
        end
      end
    end
  end
...
describe "Rendering terminating_coverage_notice template and generate pdf" do
    ...
    it "should render terminating_coverage_notice" do
      expect(@employee_notice.template).to eq "notices/shop_employee_notices/employee_terminating_dental_coverage"
    end
