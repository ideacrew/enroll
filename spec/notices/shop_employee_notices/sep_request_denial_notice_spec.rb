...
RSpec.describe SepRequestDenialNotice::OpenEnrollmentNoticeForNoRenewal, :dbclean => :after_each do
  ...
  describe "New" do
    before do
      @employee_notice = SepRequestDenialNotice::OpenEnrollmentNoticeForNoRenewal.new(census_employee, valid_parmas)
    end
    context "valid params" do
      it "should initialze" do
        expect{SepRequestDenialNotice::OpenEnrollmentNoticeForNoRenewal.new(census_employee, valid_parmas)}.not_to raise_error
      end
    end
    ...
    context "invalid params" do
      [:mpi_indicator,:subject,:template].each do  |key|
        it "should NOT initialze with out #{key}" do
          ...
          expect{SepRequestDenialNotice::OpenEnrollmentNoticeForNoRenewal.new(census_employee, valid_parmas)}.to raise_error(RuntimeError,"Required params #{key} not present")
        end
      end
    end
  end
