...
RSpec.describe ShopGeneralAgencyNotices::DefaultGeneralAgencyHiredNotice, :dbclean => :after_each do
  ...
  let!(:application_event){ double("ApplicationEventKind",{
                            :name =>'Default GA Hired',
                            :notice_template => 'notices/shop_general_agency_notices/broker_hires_default_ga_notice',
                            :notice_builder => 'ShopGeneralAgencyNotices::DefaultGeneralAgencyHiredNotice',
                            :mpi_indicator => 'SHOP_D088',
                            :event_name => 'broker_hires_default_ga_notice',
                            :title => "Broker has hired you as their default general agency"})
                          }
  let!(:valid_params) {{
  ...
  before do
    @general_agency_notice = ShopGeneralAgencyNotices::DefaultGeneralAgencyHiredNotice.new(general_agency_profile, valid_params)
  ...
  describe "New" do
    context "valid params" do
      it "should initialze" do
        expect{ShopGeneralAgencyNotices::DefaultGeneralAgencyHiredNotice.new(general_agency_profile, valid_params)}.not_to raise_error
      end
    end
    ...
    context "invalid params" do
      [:mpi_indicator,:subject,:template].each do  |key|
        it "should NOT initialze with out #{key}" do
          ...
          expect{ShopGeneralAgencyNotices::DefaultGeneralAgencyHiredNotice.new(general_agency_profile, valid_params)}.to raise_error(RuntimeError,"Required params #{key} not present")
        end
      end
    end
  end
  ...
  describe "should render template" do
    it "render template" do
      expect(@general_agency_notice.template).to eq "notices/shop_general_agency_notices/broker_hires_default_ga_notice"
    end
  end

  describe ".generating pdf" do
