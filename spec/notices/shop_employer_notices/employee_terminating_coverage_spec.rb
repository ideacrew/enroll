...
RSpec.describe ShopEmployerNotices::EmployeeTerminatingCoverage, :dbclean => :after_each do
  ...
  let(:census_employee) { FactoryBot.create(:census_employee, employee_role_id: employee_role.id, employer_profile_id: employer_profile.id, coverage_terminated_on: TimeKeeper.date_of_record.end_of_month) }
