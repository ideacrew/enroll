...
RSpec.describe ShopEmployerNotices::EeMidYearPlanChangeNoticeCongressional do
  ...
  describe "New" do
    ...
    context "valid params" do
      it "should initialze" do
        expect{ShopEmployerNotices::EeMidYearPlanChangeNoticeCongressional.new(census_employee, valid_params)}.not_to raise_error
      end
    end
    ...
    context "invalid params" do
      [:mpi_indicator,:subject,:template].each do  |key|
        it "should NOT initialze with out #{key}" do
          ...
          expect{ShopEmployerNotices::EeMidYearPlanChangeNoticeCongressional.new(census_employee, valid_params)}.to raise_error(RuntimeError,"Required params #{key} not present")
        end
      end
    end
  end
