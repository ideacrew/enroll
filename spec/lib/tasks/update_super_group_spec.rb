...
describe 'update_super_group' do
  before :all do
    @plan = FactoryGirl.create(:plan, hios_id: "88806MA0040003-01", active_year: 2017, carrier_special_plan_identifier: "NHPHM5-87DV")
    @plan2 = FactoryGirl.create(:plan, hios_id: "88806MA0040003-01", active_year: 2018, carrier_special_plan_identifier: nil)
    @plan_non_super_group = FactoryGirl.create(:plan, hios_id: "82569MA0200001-01")

    @product = FactoryGirl.create(:benefit_markets_products_health_products_health_product, hios_id: "88806MA0040003-01", issuer_assigned_id: "NHPHM5-87DV", application_period: Date.new(2017, 1, 1)..Date.new(2017, 12, 31))
    @product2 = FactoryGirl.create(:benefit_markets_products_health_products_health_product, hios_id: "88806MA0040003-01", issuer_assigned_id: nil, application_period: Date.new(2018, 1, 1)..Date.new(2018, 12, 31))
