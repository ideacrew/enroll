  ...
  context "scheduled_event:update_federal_holidays" do
    ...
    context "it creates holiday ScheduledEvent  elements correctly" do
      ...
      it_should_behave_like "a federal holiday", { type: "federal",
                                                  offset_rule: 0,
                                                  one_time: true,
                                                  start_time: "Tue, 04 Jul 2018".to_date
                                                }
    end
    context "it creates holiday ScheduledEvent  elements correctly" do
      ...
      it_should_behave_like "a federal holiday", { type: "federal",
                                                  offset_rule: 0,
                                                  one_time: true,
                                                  start_time: "Mon, 16 Jan 2018".to_date
                                                }
    end
    context "it creates holiday ScheduledEvent  elements correctly" do
      ...
      it_should_behave_like "a federal holiday", { type: "federal",
                                                  offset_rule: 0,
                                                  one_time: true,
                                                  start_time: " Mon, 20 Feb 2018".to_date
                                                }
    end
    context "it creates holiday ScheduledEvent  elements correctly" do
      ...
      it_should_behave_like "a federal holiday", { type: "federal",
                                                  offset_rule: 0,
                                                  one_time: true,
                                                  start_time: "Mon, 29 May 2018".to_date
                                                }
    end
    context "it creates holiday ScheduledEvent  elements correctly" do
      ...
      it_should_behave_like "a federal holiday", { type: "federal",
                                                  offset_rule: 0,
                                                  one_time: true,
                                                  start_time: "Mon, 04 Sep 2018".to_date
                                                }
    end
    context "it creates holiday ScheduledEvent  elements correctly" do
      ...
      it_should_behave_like "a federal holiday", { type: "federal",
                                                  offset_rule: 0,
                                                  one_time: true,
                                                  start_time: "Mon, 09 Oct 2018".to_date
                                                }
    end
    context "it creates holiday ScheduledEvent  elements correctly" do
      ...
      it_should_behave_like "a federal holiday", { type: "federal",
                                                  offset_rule: 0,
                                                  one_time: true,
                                                  start_time: "Thu, 23 Nov 2018".to_date
                                                }
    end
    context "it creates holiday ScheduledEvent  elements correctly" do
      ...
      it_should_behave_like "a federal holiday", { type: "federal",
                                                  offset_rule: 0,
                                                  one_time: true,
                                                  start_time: "Fri, 10 Nov 2018".to_date
                                                }
    end
    context "it creates holiday ScheduledEvent  elements correctly" do
      ...
      it_should_behave_like "a federal holiday", { type: "federal",
                                                  offset_rule: 0,
                                                  one_time: true,
                                                  start_time: "Mon, 02 Jan 2018".to_date
                                                }
    end
    context "it creates holiday ScheduledEvent  elements correctly" do
      ...
      it_should_behave_like "a federal holiday", { type: "federal",
                                                  offset_rule: 0,
                                                  one_time: true,
                                                  start_time: "Mon, 25 Dec 2018".to_date
                                                }
    end
