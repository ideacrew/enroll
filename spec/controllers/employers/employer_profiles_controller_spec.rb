...
RSpec.describe Employers::EmployerProfilesController do
  ...
  describe "POST create" do
    ...
    before(:each) do
      ...
      allow(organization).to receive_message_chain(:employer_profile, :welcome_employer_profile){ true }
  ...
  describe "POST create" do
    ...
    before(:each) do
      ...
      allow(found_employer).to receive_message_chain(:employer_profile, :welcome_employer_profile).and_return(true)
      allow(@user).to receive(:switch_to_idp!)
