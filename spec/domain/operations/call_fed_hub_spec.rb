...
RSpec.describe Operations::CallFedHub, type: :model, dbclean: :after_each do
  ...
  context 'Immigration status' do
    ...
    before :each do
      ...
      person.consumer_role.set(aasm_state: 'verification_outstanding', active_vlp_document_id: i327_vlp_document.id)
      person.consumer_role.save!
    end
  ...
  context 'for Invalid VLP Document type' do
    ...
    before :each do
      ...
      person.consumer_role.set(aasm_state: 'verification_outstanding', active_vlp_document_id: bad_vlp_document.id)
      person.consumer_role.save!
    end
