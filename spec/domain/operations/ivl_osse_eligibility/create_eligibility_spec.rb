...
RSpec.describe ::Operations::IvlOsseEligibility::CreateEligibility, type: :model, dbclean: :after_each do
  ...
  let(:required_params) do
    { key: key, title: title, state_histories: [history_params]}
  end
  ...
  context 'when required attributes passed' do
    ...
    it 'should create evidence' do
      result = subject.call(all_params)
      expect(result.success).to be_a(AcaEntities::People::IvlOsseEligibility::Eligibility)
    end
  end
