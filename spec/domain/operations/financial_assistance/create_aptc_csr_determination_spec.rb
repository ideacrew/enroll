...
RSpec.describe ::Operations::FinancialAssistance::CreateAptcCsrDetermination,
               type: :model,
  ...
  it 'should create aptc csr determination' do
    ...
    expect(result.success[:aptc_csr_credit][:evidence_states].keys).to eq([:income_evidence, :esi_evidence, :non_esi_evidence, :aces_evidence])
  end
end
