...
RSpec.describe ::Operations::Eligibilities::Notices::CreateReminderRequest,
               type: :model,
  ...
  describe 'Create reminder request' do
    ...
    context 'with invalid params' do
      ...
      it 'should return failure' do
        ...
        expect(result.failure).to include 'document reminder key missing'
    ...
    context 'with valid params' do
      ...
      let(:params) do
        {
          family: family,
          document_reminder_key: :document_reminder_1,
