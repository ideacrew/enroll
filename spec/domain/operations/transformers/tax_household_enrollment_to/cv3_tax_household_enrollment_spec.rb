...
RSpec.describe Operations::Transformers::TaxHouseholdEnrollmentTo::Cv3TaxHouseholdEnrollment, dbclean: :after_each do
  ...
  let!(:thhm) do
    FactoryBot.create(:tax_household_member, applicant_id: family.primary_applicant.id, tax_household: thh, csr_eligibility_kind: "csr_limited", csr_percent_as_integer: -1)
  end
