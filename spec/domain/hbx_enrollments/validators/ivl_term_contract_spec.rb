...
RSpec.describe HbxEnrollments::Validators::IvlTermContract, dbclean: :after_each do
  let(:params) do
    {kind: "individual", enrollment_kind: "open_enrollment", coverage_kind: "health",
     ...
     terminated_on: TimeKeeper.date_of_record, termination_submitted_on: TimeKeeper.date_of_record,
