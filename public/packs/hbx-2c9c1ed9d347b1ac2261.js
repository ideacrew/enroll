...
var render = function() {
  ...
  return _c("v-data-table", {
    ...
    attrs: { headers: _vm.headers, items: _vm.plans, loading: true },
    scopedSlots: _vm._u([
      {
        key: "items",
        fn: function(props) {
  ...
  computed: {
    ...
    plan_filter: function plan_filter() {
      return this.plans.filter(function (plan) {
        return this.filter_metal_level.includes(plan.metal_level) && this.filter_nationwide.includes(plan.nationwide);
      });
    }
  },
  methods: {
...
/******/ });
//# sourceMappingURL=hbx-2c9c1ed9d347b1ac2261.js.map