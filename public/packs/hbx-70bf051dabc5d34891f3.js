...
throw new Error("Module build failed: SyntaxError: this is a reserved word (58:6)\n\n  56 |         this.rows.push({id: '', carrier: {}});\n  57 |       },\n> 58 |       this.load_carrier_names() {\n     |       ^\n  59 |         this.$http.get(\"/vue/carriers\")\n  60 |         .then(response => {\n  61 |           this.tabs = response.body\n");
...
/******/ });
//# sourceMappingURL=hbx-70bf051dabc5d34891f3.js.map