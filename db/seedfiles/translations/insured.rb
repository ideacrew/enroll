...
INSURED_TRANSLATIONS = {
  ...
  "en.insured.employee_roles.select_employer.multiple_employers_message" => "The current selection will continue through the plan selection process for that enrollment, you will have the opportunity to plan shop for additional Employer Plan Year Benefits or Individual Benefits from your Employee account.",
  ...
  "en.insured.employee_roles.enroll_in_individual_benefits" => "Enroll in Individual Benefits",
  ...
  "en.insured.carrier_contact_info" => "Carrier Conatct Info",
  ...
  "en.insured.families.had_income_below_the_federal_poverty_level" => "I had income below 100% of the Federal Poverty Level and was living in a state that had not expanded Medicaid",
  ...
  "en.insured.no_employer_sponsored_insurance" => "You have no Employer Sponsored Insurance. If you believe this is an error please contact your employer.",
  "en.insured.enroll_in_the_individual_market_msg" => "You have no Employer Sponsored Insurance. If you wish to purchase insurance, please enroll in the Individual Market.",
  ...
  "en.insured.families.purchase.terminate_present_html" => "<p>Click Terminate Plan button to complete your termination from coverage.</p><p>You will remain enrolled in coverage until you terminate your plan selection below.</p>",
  "en.insured.families.purchase.terminate_not_present_html" => "<p>Your current plan selection is displayed below. Click the back button if you want to change your selection. Click Purchase button to complete your enrollment.</p><p>Your enrollment is not complete until you purchase your plan selection below.</p>",
  ...
  "en.insured.families.verification.verification_information" => "We verify the information you give us using electronic data sources. If the data sources do not match the information you gave us, we need you to provide documents to prove what you told us.",
  ...
  "en.insured.family_members.resident_index.continue_to_get_insurance" => "If you need to get insurance coverage for other members of your household, select 'Add Member'. When you’re finished, select CONTINUE.",
  "en.insured.family_members.resident_index.add_member_info_html" => "<span class='bold'>Here's your chance to add family members to your plan.</span><br>Add family members by clicking the 'Add Member' button. If you don't need to add more members, or when you are done adding members, click continue.",
  "en.month" => "Month",
  ...
  "en.level" => "Level",
  "en.network" => "Network",
  "en.family_deductible" => "Family Deductible",
