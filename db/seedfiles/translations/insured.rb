...
INSURED_TRANSLATIONS = {
  ...
  "en.insured.families.purchase.terminate_present" => "Click Terminate Plan button to complete your termination from coverage.</p><p>You will remain enrolled in coverage until you terminate your plan selection below.",
  "en.insured.families.purchase.terminate_not_present" => "Your current plan selection is displayed below. Click the back button if you want to change your selection. Click Purchase button to complete your enrollment.",
  "en.insured.families.purchase.enrollment_not_complete" => "Your enrollment is not complete until you purchase your plan selection below.",
