BROKER_AGENCIES_TRANSLATIONS = {
  ...
  "en.broker_agencies.broker_roles.new_broker_agency_form.create_broker_agency" => "Create Broker Agency",
	...
	"en.quote" => "Quote",
	"en.broker_agencies.quotes.panels.quote.quote_after_comparing_health_plan_costs" => "Please create a quote after comparing health plan costs",
	...
	"en.plan_offering_spectrum" => "Health Plan offering. Your offerings are based on",
	"en.offered" => "Offered",
	...
	"en.broker_agencies.quotes.select_the_plans" => "Please select plans for all the benefit groups assigned to households by using the",
	...
	"en.broker_agencies.quotes.template_upload"=> "If you completed your employee roster offline using our Microsift Excel template, find the file on your computer and upload it here.",
	...
	"en.quote_benefit_group_selection" => "Quote Benefit Group Selection",
