BROKER_AGENCIES_TRANSLATIONS = {
	...
	"en.broker_agency_information" => "Broker Agency Information",
	"en.broker_agencies.broker_roles.new_broker_agency_note" => "NOTE: If you are not associated with a broker agency, please enter your personal information. Do not enter a General Agency or Third Party Administrator's Information.",
	"en.create_broker_agency" => "Create Broker Agency",
	"en.email" => "Email",
	"en.npn" => "NPN",
	...
	"en.broker_agencies.quotes.duplicate_this_family_by" => "Duplicate this family by",	
