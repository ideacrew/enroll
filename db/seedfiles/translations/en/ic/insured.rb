...
-li- How to find the SEVIS ID: On the DS-2019, the number is on the top right hand side of the page in the box above the barcode.",
  ...
  :'en.go_back' => "GO BACK",
  :'en.leave_dc_health_link' => "Leave Idea Crew Demo",
  ...
  :'en.insured.homeless_dc' => "I'm a homeless STATE resident.",
  :'en.insured.moving_to_dc' => "I'm moving to STATE",
  :'en.insured.dependent_moving_to_dc' => "This person is moving to STATE",
  :'en.insured.moving_to_dc_extension' => "in the next 60 days, but don't have a STATE address yet",
  :'en.insured.outside_dc' => "I'm living outside STATE",
  :'en.insured.dependent_outside_dc' => "This person is living outside of STATE",
  :'en.insured.outside_dc_extension' => "and plan to return",
  :'en.insured.dc_homeless' => "I'm a DC resident experiencing homelessness",
  :'en.insured.dependent_dc_homeless' => "This person is STATE resident who is experiencing homeless",
  :'en.insured.dc_homeless_extension' => ", or have no permanent home address",
  :'en.insured.temp_outside_dc' => "I'm living outside of STATE and plan to return, or am moving to STATE but don’t have a STATE address yet.",
  ...
  :'en.apply' => "Apply",
  :'en.reset' => "Reset",
  :'en.modal_onscreen' => "We're sending you to Idea Crew Demo's Plan Match tool powered by Consumers'",
  :'en.modal_onscreen1' => "CHECKBOOK. For security reasons, you'll need to login to your Idea Crew Demo",
