HBX_PROFILES_TRANSLATIONS = {
  ...
  "en.hbx_profiles.confirm_create_ba_warning" => "Creating a new application will cancel or terminate the existing application.",
	...
	"en.financial_assistance.applications.cant_determine_eligibility" => "We’re sorry, but we can’t determine your eligibility right now. Please call %{Settings.site.short_name} at %{Settings.contact_center.phone_number} or email %{Settings.contact_center.email_address} to report this issue.",
