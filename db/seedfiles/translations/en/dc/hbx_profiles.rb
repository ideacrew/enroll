HBX_PROFILES_TRANSLATIONS = {
  ...
  "en.hbx_profiles.confirm_create_ba_warning" => "Creating a new application will cancel or terminate the existing application.",
	...
	"en.financial_assistance.applications.report_error" => "Report the error code '<%= @application.determination_http_status_code %>' to help us fix the problem as soon as possible.",
