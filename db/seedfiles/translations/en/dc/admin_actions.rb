...
ADMIN_ACTIONS_TRANSLATIONS = {
  ...
  'en.admin_actions.drop_member_description' => 'This tool allows Admins to drop members from an active Individual Market enrollment. The tool will only be available for families where more than one member exists in the family and there is at least one active individual market health or dental enrollment.',
  'en.admin_actions.enrollment_hbx_id' => 'Enrollment HBX ID',
  'en.admin_actions.drop_member' => 'Drop Member',
