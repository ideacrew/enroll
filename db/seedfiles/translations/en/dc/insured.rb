...
-li- How to find the SEVIS ID: On the DS-2019, the number is on the top right hand side of the page in the box above the barcode.",
  ...
  :'en.agree' => "I agree",
  :'en.agree' => "I disagree",
  :'en.insured.consumer_roles.verify_identity_agreement' => "<p><b>We are required by federal law to verify your identity before you continue with your application.</b> If you do not want to continue with identity verification through Experian, you can apply by completing and sending us a <a href='https://dchealthlink.com/sites/default/files/v2/forms/DC_Health_Link_Application_for_Health_Coverage_201509.pdf' target='_blank;>paper application </a> or going to a <a href='https://dchealthlink.com/dhsservicecenters' target='_blank'>Department of Human Services service center </a> to apply in person.</p>",
