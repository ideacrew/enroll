...
-li- How to find the SEVIS ID: On the DS-2019, the number is on the top right hand side of the page in the box above the barcode.",
  ...
  :'en.add_broker_agency_staff' => "Add Broker Agency Staff",
  :'en.select_this_broker_button' => "Select This Broker",
  :'en.broker_agency_note' => "NOTE: If you are not associated with a broker agency, please enter your personal information. Do not enter a General Agency or Third Party Administrator‘s Information.",
  ...
  :'en.insured.family_members.index.continue_to_get_insurance' => "If you need to add other members to your health insurance, select 'Add New Member'. When you’re finished, select CONTINUE.",
  ...
  :'en.total_available_aptc_amount' => "Maximum tax credit available",
  ...
  :'en.aptc_slider_credit' => 'Tax credit applied (%)',
  :'en.tax_credit_value' => 'Tax credit value ($)',
