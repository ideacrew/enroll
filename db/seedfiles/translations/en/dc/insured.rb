...
-li- How to find the SEVIS ID: On the DS-2019, the number is on the top right hand side of the page in the box above the barcode.",
  ...
  :'en.apply' => "Apply",
  :'en.reset' => "Reset",
  :'en.modal_onscreen' => "We're sending you to Access Health CT's Plan Match tool powered by Consumers'",
  :'en.modal_onscreen1' => "CHECKBOOK. For security reasons, you'll need to login to your Access Health CT",
