EXCHANGE_TRANSLATIONS = {
  ...
  "en.exchange.manage_sep_types.manage_sep_types" => "Manage SEP Types",
  "en.exchange.manage_sep_types.sorting_sep_types" => "Sorting SEP Types",
  "en.exchange.manage_sep_types.create_sep_types" => "Create SEP Types",
