...
EMPLOYER_TRANSLATIONS = {
  ...
  :'en.employers.employer_profiles.mailer.success' => " records uploaded from CSV.",
  :'en.employers.employer_profiles.mailer.failure' => "Employees are not created.",
  :'en.employers.employer_profiles.mailer.error' => "Employees are not created, please check the following error.",
