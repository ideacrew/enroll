...
EMPLOYER_TRANSLATIONS = {
  ...
  :'en.osse_ivl_description' => "HealthCare4ChildCare (HC4CC) provides free health insurance for District residents (and their families) who are employees of OSSE licensed child development centers and homes. Only Admin can confirm HC4CC eligibility for each household member listed below <strong>prior</strong> to submitting a new enrollment.",
