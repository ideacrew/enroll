...
EMPLOYER_TRANSLATIONS = {
  ...
  :'en.osse_bqt_eligibility_description' => "Licensed child development centers and homes and their employees are eligible for premium reductions. Eligibility is applied to an initial or renewal plan year when the plan year is created.",
