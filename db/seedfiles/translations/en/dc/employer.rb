EMPLOYER_TRANSLATIONS = {
  ...
  :'en.employers.plan_years.benefits_without_plan' => "It's time to create a benefits package. Select 'Add Plan Year' to create your first one. Most employers only create one benefits package but you'll have the opportunity to create more than one if you want to offer different benefits to different
        groups of employees.",
  ...
  :'en.employers.plan_years.benefits_with_plan.important' => "<strong>IMPORTANT</strong></br><p> – Once you select 'Publish Plan Year', your employees will receive a notification and open enrollment will begin according to the timeline you selected for your plan year.</p>",
