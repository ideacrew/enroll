BROKER_AGENCIES_TRANSLATIONS = {
  ...
  "en.broker_agencies.broker_roles.new_broker_agency_form.create_broker_agency" => "Submit",
	...
	"en.broker_agencies.broker_invitation.create_broker_acc" => "Please visit <a href='claim_invitation_url(invitation)' target='_blank'> %{site_short_name} </a> to create your broker account and manage your clients.",
	...
	"en.broker_agencies.broker_application_confirm.more_info" => "More information about these requirements is included in the <a href="%{site_broker_registration_guide}">Broker Registration Guide",
