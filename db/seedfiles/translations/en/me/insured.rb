...
-li- How to find the SEVIS ID: On the DS-2019, the number is on the top right hand side of the page in the box above the barcode.",
  ...
  :'en.insured.individual_agreement.non_aptc' => "<p>I understand that I must report any changes that might affect my eligibility or the eligibility of a household member for health insurance. I can report changes by going online and logging into my account, by calling the CoverME.gov Consumer Assistance Center at (866) 636-0355, or by submitting information via mail.</p><p>I'm the person whose name appears in the signature line below. I understand that I’m submitting an application for health insurance and that information I provided will be used to decide eligibility for each member of my application group.</p><p>I've reviewed the information in this application, and I attest under penalty of perjury, that it’s accurate and complete to the best of my knowledge. I understand if I’m not truthful, there may be a penalty, including retroactive termination of my coverage and an obligation to repay all medical claims previously covered by the health insurance company.</p>",
  :'en.insured.individual_agreement.aptc_present'  => "<p>I understand that because the premium tax credit will be paid on my behalf to reduce the cost of health coverage for myself and/or my dependents:<ul><li>I must file a federal income tax return for the %{coverage_year} tax year.<li>If I’m married at the end of %{coverage_year}, I must file a joint income tax return with my spouse.</li></ul><p>I also expect that:</p><ul><li>No one else will be able to claim me as a dependent on their %{coverage_year} federal income tax return.</li><li>I’ll claim as a dependent on my %{coverage_year} federal income tax return all individuals I listed on my application as my dependent, who are enrolled in coverage through %{site_short_name}, and whose premium for coverage is paid in whole or in part by advance payments of the premium tax credit.</li></ul><p>If any of this changes:</p><ul><li>I understand that it may impact my ability to get the premium tax credit.</li><li>I also understand that when I file my %{coverage_year} federal income tax return, the Internal Revenue Service (IRS) will compare the income on my tax return with the income on my application. I understand that if the income on my tax return is lower than the amount of income on my application, I may be eligible to get an additional premium tax credit amount. On the other hand, if the income on my tax return is greater than the amount of income on my application, I may owe additional federal income tax.</li></ul>",
