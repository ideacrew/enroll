...
-li- How to find the SEVIS ID: On the DS-2019, the number is on the top right hand side of the page in the box above the barcode.",
  ...
  :'en.why_are_you_cancelling' => "Why are you cancelling your plan?",
  :'en.cancelation_reason' => "Cancelation Reason",
  :'en.cancel_your_plan' => "Cancel Your Plan?",
  :'en.back_to_enrollment_history' => "Back to Enrollment History",
  :'en.plan_cancellation' => "Plan Cancellation",
  :'en.DCHL' => "DCHL",
  :'en.ID' => "ID",
  ...
  :'en.cancel_plan_confirmation' => "Cancelling means you will no longer have health insurance thorugh CoverME.gov. You will not be able to enroll in a new plan unless it's Open Enrollment or if you have a special enrollment period due to a qualifying life event.",
