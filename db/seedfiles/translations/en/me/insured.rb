...
-li- How to find the SEVIS ID: On the DS-2019, the number is on the top right hand side of the page in the box above the barcode.",
  ...
  :'en.insured.consumer_roles.match.ssn_dob_name_error' => "This Social Security Number, Date-of-Birth and Name are invalid in our records. Please verify the entry, and if correct, contact the %{state_abbreviation} Customer help center at %{contact_center_phone_number}.",
  :'en.insured.consumer_roles.match.ssn_dob_error' => "This Social Security Number and Date-of-Birth is invalid in our records.  Please verify the entry, and if correct, contact the %{state_abbreviation} Customer help center at %{contact_center_phone_number}.",
  ...
  :'en.insured.contact_preference' => "How would you like to get notices and updates from CoverME.gov? Check all that apply",
  ...
  :'en.apply' => "Apply",
  :'en.reset' => "Reset",
  :'en.modal_onscreen' => "We're sending you to Cover ME's Plan Match tool powered by Consumers'",
  :'en.modal_onscreen1' => "CHECKBOOK. For security reasons, you'll need to login to your Cover ME",
