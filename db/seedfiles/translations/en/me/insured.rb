...
-li- How to find the SEVIS ID: On the DS-2019, the number is on the top right hand side of the page in the box above the barcode.",
  ...
  :'en.insured.family_members.duplicate_error_message' => "Cannot remove the duplicate members as they are present on enrollments/tax households. Please call customer service at %{contact_center_phone_number}.",
  :'en.month' => "Month",
