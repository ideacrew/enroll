...
-li- How to find the SEVIS ID: On the DS-2019, the number is on the top right hand side of the page in the box above the barcode.",
  ...
  :'en.insured.families.change_type' => "Change Type",
  :'en.insured.families.change_details' => "Change Details",
  :'en.insured.families.last_action' => "Last Action",
  :'en.insured.families.action_by' => "Action By",
