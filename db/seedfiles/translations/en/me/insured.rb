...
-li- How to find the SEVIS ID: On the DS-2019, the number is on the top right hand side of the page in the box above the barcode.",
  ...
  :'en.privacy_statement' => "<b><a href='https://www.ideacrew.com' target='_blank'>IdeaCrew</a></b> understands that you are providing us with personal information about yourself and your family.  We take the protection of that information very seriously. <b><a href='https://www.ideacrew.com' target='_blank'>IdeaCrew</a></b> wants you to understand that your information will be used only to see whether you or your family member(s) qualify for a Marketplace health insurance plan or financial help to make your plan more affordable.
                    ...
                    <br/><br/>
                    You can learn more about how we will use your information by accessing the <b><a href='https://www.ideacrew.com' target='_blank'>IdeaCrew</a></b> Privacy Policy which can be accessed at any time at <a href='https://www.ideacrew.com/privacy-policy'  target='_blank' style='color: blue'>www.ideacrew.com/privacy-policy</a>.
                    <br/><br/>
                    By selecting <b>CONTINUE</b>, you are saying that you <b>understand</b> how <b><a href='https://www.ideacrew.com' target='_blank'>IdeaCrew</a></b> will use the information you provide in your application, and you agree to continue with the application process. You are also indicating that you have permission from all of the people listed on the application for their information to be retrieved and used from data sources.",
  ...
  :'en.insured.consumer_roles.search.enter_personal_info_msg' => "Enter your personal information. We’ll check to see if you already have an existing application with IdeaCrew. This application could be from an application you had with Healthcare.gov, the State Office for Family Independence or one you've completed with us previously. If your family has applied to one of these places, use the information of the person who completed that application here. When you are finished, select CONTINUE.",
  ...
  :'en.insured.consumer_roles.search.gender_tooltip' => "Sex is a required field on the application. You can choose how to answer this question, and we don’t compare your response against any data sources. The sex you choose is included in the information we send to your insurance company, but it’s a violation of State law to restrict access to health benefits based on sex or identity.",
  ...
  :'en.insured.contact_preference' => "How would you like to get notices and updates from IdeaCrew? Check all that apply<br/>Note: Standard data rates may apply for text messages",
  ...
  :'en.insured.answer_for_assister' => "State Enrollment Assisters help state residents find quality, affordable health insurance through %{site_short_name}. Assisters are trained experts with deep roots and trusted relationships in the state and its communities. Assisters provide unbiased information and help you apply for either Medicaid or CHIP (the Children’s Health Insurance Program) or a Marketplace plan, but they won’t endorse a specific plan choice for you. Assisters must complete rigorous training and pass criminal background checks prior to service. There is no cost to use an Assister.",
  :'en.insured.what_is_a_broker?' => "What is a Broker?",
  :'en.insured.answer_for_broker' => "Brokers are licensed professionals with health insurance expertise who can help you find a plan that fits your needs. In the State, Brokers must have an active state insurance license in good standing, and complete training on %{site_short_name}. A broker will be able to help you at no cost to you, but they may get paid by an insurance company.",
  ...
  :'en.insured.dc_homeless' => "I'm a state resident experiencing homelessness",
  :'en.insured.dependent_dc_homeless' => "This person is experiencing homeless",
  ...
  :'en.insured.group_selection.new.coverall_benefits' => "Cover All State Benefits",
  ...
  :'en.apply' => "Apply",
  :'en.reset' => "Reset",
  :'en.modal_onscreen' => "We're sending you to the Plan Compare tool powered by Consumers'",
  :'en.modal_onscreen1' => "CHECKBOOK. For security reasons, you'll need to login to your account",
