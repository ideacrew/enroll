...
-li- How to find the SEVIS ID: On the DS-2019, the number is on the top right hand side of the page in the box above the barcode.",
  ...
  :'en.insured.match_person.dob_valid_error' => "Please verify your date of birth. If it's correct, please continue.",
  :'en.insured.match_person.dob_valid_error_2' => "Please verify your date of birth. If it's correct, please continue to the next step.",
