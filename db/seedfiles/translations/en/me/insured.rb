...
-li- How to find the SEVIS ID: On the DS-2019, the number is on the top right hand side of the page in the box above the barcode.",
  ...
  :'en.insured.consumer_roles.upload_ridp_documents.in_person_details' => "You can set up an appointment to complete an application in person at the %{site_short_name} Consumer Assistance Center staff. Call %{phone} to set up an appointment.",
  :'en.insured.consumer_roles.upload_ridp_documents.paper_application' => "Upload a paper application",
  :'en.insured.consumer_roles.upload_ridp_documents.paper_application_details' => "Complete a paper application and upload it. %{site_short_name} Consumer Assistance Center staff will need to review your application. You will not be able to access your information online, unless you also provide documents proving your identity.",
  ...
  :'en.self' => "Self",
  :'en.insured.families.financial_assistance_add_or_remove_family_member' => "You have added/removed/edited a family member on your profile. Please update your financial assistance application.",
  :'en.insured.families.add_or_remove_family_html' => "You have added/removed a family member to your profile. You may qualify for a special enrollment period.",
  :'en.insured.families.go_to_applications' => "Go to Applications",
  ...
  :'en.documents_list_title' => "Uploaded Documents for %{document_type}",
  ...
  :'en.actions' => "Actions",
  :'en.no_actions' => "No actions available",
  ...
  :'en.enrollment_history.show_all' => "Show All Enrollments",
  :'en.enrollment_history.hide_all' => "Hide Inactive Enrollments",
  ...
  :'en.go_to_my_account' => "Go To My Account",
  ...
  :'en.insured.what_is_a_broker_or_assister' => "What is a Broker or Assister?",
  ...
  :'en.insured.brokers.removal_confirm' => "Yes, Remove Expert",
  ...
  :'en.issuer' => "Issuer",
  :'en.broker' => "Broker",
  :'en.broker_agencies.invalid_dob_title' => "Invalid DOB Format",
  :'en.broker_agencies.invalid_dob_body' => "DOB must be entered as MM/DD/YYYY",
  :'en.broker_agencies.invalid_dob_after' => "DOB cannot be after %{date}",
  :'en.broker_agencies.invalid_dob_before' => "DOB cannot be before %{date}",
  ...
  :'en.insured.qle_detail.event_details' => "Event Details",
  :'en.insured.qle_detail.event_date' => "Event Date",
  ...
  :'en.insured.qle_detail.special_reason.move.calculator' => "(Use the calculator to see if you qualify)",
  ...
  :'en.insured.shop_for_health_or_dental_plans' => "Shop for Health or Dental Plans",
  :'en.insured.update_family_information' => "Update Family Information",
  :'en.insured.assign_an_expert' => "Assign an Expert",
  :'en.insured.go_to_my_expert' => "Go to My Expert",
  :'en.insured.shop_for_plans' => "Shop for Plans",
  :'en.insured.display_all_enrollments' => "Display All Enrollments",
  ...
  :'en.other_coverage_cancel' => "I have other coverage",
  :'en.move_cancel' => "I'm moving out of Maine",
  ...
  :'en.available_monthly' => "Available Monthly:",
  :'en.amount_applied' => "Amount Applied:",
  ...
  :'en.insured.interactive_identity_verifications.failed_validation.upload_doc_details' => "%{site_short_name} Consumer Assistance Center staff will need to review and approve what you upload before you can continue. This can take 3-5 business days.",
  ...
  :'en.see_details' => "View Plan Details",
  ...
  :'en.print' => "Print",
  :'en.insured.plan_shoppings.show.title' => "Plan Selection",
  :'en.insured.plan_shoppings.show.health_title.content' => "To enroll in a plan, use 'Select Plan' on the plan tile. To help you find a plan that's right for you, return to the 'Previous Page' and use the Plan Comparison Tool.",
  ...
  :'en.insured.plan_shoppings.thankyou.total_credit' => "The total tax credit amount the people on this plan qualify for is",
  :'en.insured.plan_shoppings.thankyou.max_credit' => "The maximum amount you can use for this plan is",
  :'en.insured.plan_shoppings.thankyou.percent_applied' => "Percentage Applied",
  :'en.insured.plan_shoppings.thankyou.amount_applied' => "Amount Applied",
  ...
  :'en.insured.plan_shoppings.thankyou.aptc_instructions' => "Use the Percentage Applied or Amount Applied inputs below to tell us how much of your total tax credit you’d like to use. We’ll apply up to the maximum amount you can use for this plan.",
  :'en.insured.plan_shoppings.thankyou.aptc_desc' => "You can decide if you want to use all, some, or none of your estimated APTC to lower your monthly premium. To change the amount of APTC applied, select 'Update APTC Amount.'",
  ...
  :'en.enrollment_member.enrollment_services' => 'Enrollment Services & Estimated Costs',
