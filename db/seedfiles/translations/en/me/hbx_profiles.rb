HBX_PROFILES_TRANSLATIONS = {
  ...
  "en.hbx_profiles.sep_admin_comment" => "Admin Comment",
	...
	"en.hbx_profiles.user_accounts.actions.edit.current_username" => "Current Username",
	"en.hbx_profiles.user_accounts.actions.edit.username" => "New Username",
	"en.hbx_profiles.user_accounts.actions.edit.confirm_username" => "Confirm New Username",
	"en.hbx_profiles.user_accounts.actions.edit.username_placeholder" => "firstlast00",
	"en.hbx_profiles.user_accounts.actions.edit.current_email" => "Current Email",
	"en.hbx_profiles.user_accounts.actions.edit.email" => "New Email",
	"en.hbx_profiles.user_accounts.actions.edit.confirm_email" => "Confirm New Email",
	"en.hbx_profiles.user_accounts.actions.edit.email_placeholder" => "email@example.com",
