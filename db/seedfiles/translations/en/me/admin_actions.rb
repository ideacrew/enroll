...
ADMIN_ACTIONS_TRANSLATIONS = {
  ...
  'en.admin_actions.dry_run.applications.title' => 'Dry Run Dashboard',
  'en.admin_actions.dry_run.application_renewal_status' => 'Application Renewals Status',
  ...
  'en.admin_actions.dry_run.benefits.create_renewals_on_date_change_feature_enabled' => "Create renewals on date change feature is enabled",
