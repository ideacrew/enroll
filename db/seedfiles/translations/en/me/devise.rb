...
DEVISE_TRANSLATIONS = {
  ...
  :'en.devise.requirement1' => "Password must match password confirmation",
  :'en.devise.requirement2' => "Cannot contain the email/username",
  :'en.devise.requirement3' => "Must contain at least 8 characters",
  :'en.devise.requirement4' => "Must contain at least one uppercase letter",
