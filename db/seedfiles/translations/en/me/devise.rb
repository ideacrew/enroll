# Devise Translations
DEVISE_TRANSLATIONS = {
  :'en.devise.sign_in.heading' => "Sign In",
  :'en.devise.sign_in.username' => "Username",
  :'en.devise.sign_in.blank_username' => "Please enter your username.",
  :'en.devise.sign_in.password' => "Password",
  :'en.devise.sign_in.blank_password' => "Please enter your password.",
  :'en.devise.sign_in.remember_me' => "Remember Me",
