BROKER_AGENCIES_TRANSLATIONS = {
  ...
  "en.dba_caps" => "DBA",
	...
	"en.broker_agencies.profiles.npn_taken_error" => "<ul><li>This NPN is already registered on <a target='_blank' rel='noopener noreferrer' href='%{main_web_address}'>%{site_short_name}.</a></li><li>If you have clients on <a target='_blank' href='%{website_url}'>HealthCare.gov</a>, you do not need to register. We’ll email you an account invitation once you’ve completed training and we’ve confirmed your active license with health authority with the Maine Bureau of Insurance.</li><li>If you work for a broker but do not have your own NPN, please register using the Expert Staff option. If you already have an account on <a href='%{main_web_address}'>%{site_short_name}</a>, login to that account.</li><li>If you have questions, call <a target='_blank' href='%{main_web_address}'>%{site_short_name}</a> at %{contact_center_short_number}.</li></ul>",
