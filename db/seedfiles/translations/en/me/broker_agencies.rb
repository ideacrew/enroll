BROKER_AGENCIES_TRANSLATIONS = {
	...
	"en.broker_agencies.broker_roles.search_broker_agencies" => "Search",
  "en.broker_agencies.broker_roles.agency_name_placeholder" => "Agency Name or NPN",
	"en.search" => "Search",
  ...
  "en.placeholder_email" => "name@acme.com",
	"en.npn" => "NPN",
	"en.npn_placeholder" => "000000000",
	"en.city" => "City",
	"en.select_state" => "Select State",
	"en.date_of_birth" => "Date of Birth",
	"en.dob_format" => "mm/dd/yyyy",
	"en.legal_name"=> "Legal Name",
  "en.legal_name_placeholder"=> "Agency Legal Name",
	"en.legal_name_error"=> "Please provide a valid Legal Name.",
  "en.legal_name_caps"=> "LEGAL NAME",
	...
	"en.broker_registration"=> "Broker Agency Registration",
  ...
  "en.broker_agencies.add_broker_staff_member" => "Add Staff Member",
  "en.broker_agencies.cancel_new_staff" => "Cancel New Staff",
  "en.broker_agencies.create_new_staff" => "Create New Staff Member",
  "en.broker_agencies.agency_details" => "Agency Details",
  "en.broker_agencies.edit_icon" => "Pencil Icon",
  "en.broker_agencies.edit_profile" => "Edit Agency Profile",
  "en.broker_agencies.staff" => "Staff",
  "en.broker_agencies.active" => "Active",
  "en.broker_agencies.pending" => "Pending",
  "en.broker_agencies.linked" => "Linked",
  "en.broker_agencies.unlinked" => "Unlinked",
  "en.broker_agencies.approve" => "Approve",
  "en.broker_agencies.remove_staff_role" => "Remove Staff Role",
  "en.broker_agencies.remove" => "Remove",
  "en.broker_agencies.consumer" => "Consumer",
  "en.broker_agencies.employee" => "Employee",
  ...
  "en.available_working_hours?" => "Available Weekend/Evening Hours?",
  "en.accepting_new_clients?" => "Accepting New Clients?",
  "en.default_yes_no" => "Yes / No",
  "en.default_select_error" => "Please select an option.",
  "en.select_all_that_apply" => "Select all that apply",
	"en.broker_agencies.profiles.clear_default_ga" => "Clear Default GA",
	"en.dba" => "dba",
  "en.dba_caps" => "DBA",
  "en.doing_business_as" => "Doing Business As",
	"en.entity_kind" => "Entity Kind",
	"en.market_kind" => "Market Kind",
	"en.address_kind" => "Address Kind",
	"en.add_office_location" => "Add Office Location",
	"en.market_kind_error" => "Please select a valid Market Kind.",
