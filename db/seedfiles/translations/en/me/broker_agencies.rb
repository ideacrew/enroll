BROKER_AGENCIES_TRANSLATIONS = {
  ...
  "en.dba_caps" => "DBA",
	...
	"en.broker_agencies.profiles.npn_taken_error" => "<ul><li>This NPN is already registered on <a target='_blank' href='%{main_web_address}'>%{site_short_name}.</a></li><li>If you have clients on <a target='_blank' href='%{website_url}'>HealthCare.gov</a>, you do not need to register. We’ll email you an account invitation once you’ve completed training and we’ve confirmed your active license with health authority with the State Bureau of Insurance.</li><li>If you work for a broker but do not have your own NPN, please register using the Expert Staff option. If you already have an account on <a href='%{main_web_address}'>%{site_short_name}</a>, login to that account.</li><li>If you have questions, call <a target='_blank' href='%{main_web_address}'>%{site_short_name}</a> at %{contact_center_short_number}.</li></ul>",
	"en.broker_agencies.broker_invitation.thank_you_registering" => "Thank you for registering as a broker through %{site_short_name}.",
	"en.broker_agencies.broker_invitation.create_broker_acc" => "Please visit <a href= %{url} target='_blank'> %{site_short_name} </a> to create your broker account and manage your clients.",
  ...
  "en.broker_attestation.active_license" => "I have an active license with health authority with the State Bureau of Insurance",
