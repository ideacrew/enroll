...
EMPLOYER_TRANSLATIONS = {
  ...
  :'en.employers.plan_years.benefits_without_plan' => "<p>It’s time to create a benefits package for your employees.</br><ul><li>To set up a plan, select 'Add Plan Year'</li><li>If your broker already set up a plan quote for you to consider, select 'Claim Quote'</li></ul></p>",
  ...
  :'en.employers.plan_years.benefits_with_plan.important' => "<strong>IMPORTANT:</strong></br><ul><li>Your employees will need to take action after your plan year is published. We will send them an email, email letting them know once their open enrollment period has begun.</li><li>Your employees will need to sign into their account to waive or enroll in their benefits during open enrollment. If they do not take this step, they will not be enrolled in your plan.</li></ul>",
  :'en.employers.plan_years.oe_tool_tip' => "Your employees need to sign in to waive or enroll in coverage by the 20th of the month, the month before your plan begins. If employee don’t act by the 20th, they won’t be enrolled in your plan the following month.If you have questions about setting your open enrollment dates, please call us at 1-888-813-9220.",
  ...
  :'en.employers.employer_profiles.welcome.complete_your_employee_roster.content_html' => "<ul><li>To complete your Employee Roster, select the Employees tab and follow the instructions for adding employees to your group.</li><li>To work on choosing your plan, select the Benefits tab to get started</li></ul>"
}.freeze
