BROKER_AGENCIES_TRANSLATIONS = {
  ...
  "en.broker_agencies.broker_invitation.create_new_acc" => "<strong>1.</strong> Click on this personalized link to set up your new broker account: <a href='%{claim_invitation_url(invitation)}' target='_blank'> %{site_short_name} </a><br /><strong>Important:</strong> You must use this link to set up your account. If you don't use your personalized link when creating your account, the account won't be connected to your existing broker profile.",
