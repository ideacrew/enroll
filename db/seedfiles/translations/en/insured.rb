...
INSURED_TRANSLATIONS = {
  ...
  "en.reset" => "Reset",
  "en.confirm" =>"Confirm",
  "en.modal_onscreen" => "You are about to redirect to a separate website where you can compare coverage options using Plan Match, a decision-support tool that features on out-of-pocket cost calculator, integrated provider and drug directories, and more.",
