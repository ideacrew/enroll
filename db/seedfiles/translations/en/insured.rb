...
INSURED_TRANSLATIONS = {
  ...
  "en.modal_onscreen1" => "You are about to be redirected from the DC Health Link website to DC Health Link’s",
  "en.modal_onscreen2" => "Plan Match tool powered by Consumers’ CHECKBOOK. This is a third-party website",
  "en.modal_onscreen3" => "where you can compare plan features, benefits, and costs side-by-side. You can also",
  "en.modal_onscreen4" => "see if your doctors are in-network and if your prescription drugs are covered.",
  "en.modal_onscreen5" => "DC Health Link, the District of Columbia Health Benefit Exchange Authority and the",
  "en.modal_onscreen6" => "government of the District of Columbia do not control and are not responsible for the",
  "en.modal_onscreen7" => "content of third-party websites. For your security,if you’ve been shopping for more than",
  "en.modal_onscreen8" => "15 minutes, you’ll need to login again, though you will be able to save a copy of your",
  "en.modal_onscreen9" => "plan comparison results.",
