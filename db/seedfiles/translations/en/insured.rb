...
INSURED_TRANSLATIONS = {
  ...
  "en.modal_onscreen" => "We're sending you to Be Well NM's Plan Match tool powered by Consumers'",
  "en.modal_onscreen1" => "CHECKBOOK. For security reasons, you'll need to login to your Be Well NM",
