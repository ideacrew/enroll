...
INSURED_TRANSLATIONS = {
  ...
  "en.modal_onscreen" => "You are about to be redirected from the DC Health Link website to DC Health Link’s Plan Match tool powered by Consumers’ CHECKBOOK. This is a third-party website where you can compare plan features, benefits, and costs side-by-side. You can also see if your doctors are in-network and if your prescription drugs are covered. DC Health Link, the District of Columbia Health Benefit Exchange Authority, and the government of the District of Columbia do not control and are not responsible for the content of third-party websites. For your security, if you’ve been shopping for more than 15 minutes, you’ll need to login again, though you will be able to save a copy of your plan comparison results.",
