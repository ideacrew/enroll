...
translations = {
  ...
  "en.uis.bootstrap3_examples.index.paragraph1" => "we can group buttons in 3 different ways",
  "en.uis.bootstrap3_examples.index.paragraph2" => "First type of grouping default is :",
  ...
  "en.uis.bootstrap3_examples.index.paragraph3" => "we can also mix input groups with button groups",
  "en.uis.bootstrap3_examples.index.panels" => "Panels",
  "en.uis.bootstrap3_examples.index.paragraph4" => "Panel Heading for enrollment reports goes here",
  "en.uis.bootstrap3_examples.index.paragraph5" => "It will display the all the enrollment reports",
  ...
  "en.uis.bootstrap3_examples.index.paragraph6" => "We can put the list of groups in panel while displaying them using JS and we can use Hover as well while moving the cursor to different panels",
  "en.uis.bootstrap3_examples.index.history" => "History",
  "en.uis.bootstrap3_examples.index.paragraph7" => "Here goes the respective histroy text",
  ...
  "en.uis.bootstrap3_examples.index.paragraph8" => "Panel Footer Example",
  "en.uis.bootstrap3_examples.index.paragraph9" => "Panel header goes here",
  "en.uis.bootstrap3_examples.index.paragraph10" => "Load the panel body content here",
  "en.uis.bootstrap3_examples.index.paragraph11" => "Panel footer goes here "
}
