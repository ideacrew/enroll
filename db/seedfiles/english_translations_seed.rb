...
translations = {
  ...
  "en.uis.bootstrap3_examples.contextual_alternatives" => "Contextual alternatives",
  ...
  "en.uis.bootstrap3_examples.index.dismissal_popover_content" => "And here's some amazing content. It's very engaging. Right?",
