Mongoid::Migration.say_with_time("Load MA Benefit Market Catalogs") do
  ...
  [2017, 2018].each do |calender_year|
    ...
    def products_for(product_package, calender_year)
      ...
      BenefitMarkets::Products::HealthProducts::HealthProduct.by_product_package(product_package).collect { |prod| prod.create_copy_for_embedding(product_package, product_package.relations["products"]) }
    end
