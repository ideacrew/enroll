...
admin_user    = User.create!(email: "admin@dc.gov", oim_id: "admin@dc.gov", password: "aA1!aA1!bB2@", password_confirmation: "aA1!aA1!bB2@", roles: ["hbx_staff"])
...
def create_staff member
   user = User.create!(email: member[:email], oim_id: member[:email], password: "aA1!aA1!bB2@", password_confirmation: "aA1!aA1!bB2@", roles: [member[:role]])
