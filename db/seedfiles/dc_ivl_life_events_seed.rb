...
QualifyingLifeEventKind.find_or_create_by(
  ...
  qlek.update_attributes(
    tool_tip: "Entering a domestic partnership as permitted or recognized by #{Settings.aca.state_name}",
    action_kind: "add_member",
    market_kind: "individual",
...
QualifyingLifeEventKind.find_or_create_by(
  title: "Moved or moving to #{Settings.aca.state_name}"
).tap do |qlek|
  qlek.update_attributes(
    tool_tip: " ",
    action_kind: "add_benefit",
...
QualifyingLifeEventKind.find_or_create_by(
  title: "Lost eligibility for a hardship exemption").tap do |qlek|
  qlek.update_attributes(
...
QualifyingLifeEventKind.find_or_create_by(
  title: "Beginning or ending service with AmeriCorps State and National, VISTA, or NCCC").tap do |qlek|
  qlek.update_attributes(
  tool_tip: " ",
  action_kind: "add_member",
  market_kind: "individual",
...
QualifyingLifeEventKind.find_or_create_by(
  title: "Court order to provide coverage for someone").tap do |qlek|
  qlek.update_attributes(
  tool_tip: " ",
  action_kind: "add_member",
  market_kind: "individual",
...
QualifyingLifeEventKind.find_or_create_by(
  title: "Newly eligible due to citizenship or immigration status change").tap do |qlek|
  qlek.update_attributes(
  tool_tip: " ",
  action_kind: "add_benefit",
  market_kind: "individual",
...
QualifyingLifeEventKind.find_or_create_by(
  title: "Found ineligible for Medicaid after open enrollment ended").tap do |qlek|
  qlek.update_attributes(
