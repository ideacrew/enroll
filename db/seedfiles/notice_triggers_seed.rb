...
ivl_notice_triggers = [
  ...
  {
    hbx_id: 'IVL_PRE_1',
    title: 'Update your information at PID by October 15',
  ...
  },
  {
    ...
    description: 'Notice will be sent to all the individuals eligible for coverage through PID',
    resource_name: 'consumer_role',
  ...
  {
    hbx_id: 'IVL_NEL',
    title: 'IMPORTANT NOTICE - INELIGIBLE FOR COVERAGE THROUGH PID',
  ...
  {
    hbx_id: 'IVL_CDC',
    title: 'Your Insurance through PID Has Changed to Cover All DC',
  ...
  {
    hbx_id: 'IVL_DCH',
    title: 'Your Insurance through Cover All DC Has Changed to PID',
    description: 'This is an Transition Notice and is sent for people who are moved to PID',
    resource_name: 'consumer_role',
