class Insured::GroupSelectionController < ApplicationController
  ...
  def create
    ...
    update_tobacco_field(hbx_enrollment.hbx_enrollment_members) if ::EnrollRegistry.feature_enabled?(:tobacco_cost) && !::EnrollRegistry.feature_enabled?(:default_tobacco_question_true)
