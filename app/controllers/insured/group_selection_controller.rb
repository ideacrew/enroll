class Insured::GroupSelectionController < ApplicationController
  ...
  def new
    ...
    @new_effective_on = calculate_effective_on(market_kind: @market_kind, employee_role: @employee_role, benefit_group: select_benefit_group(qle), effective_on_option_selected: effective_on_option_selected)
