class Insured::FamiliesController < FamiliesController
  ...
  def record_sep
    ...
    action_params = {person_id: @person.id, consumer_role_id: @person.consumer_role.try(:id), employee_role_id: params[:employee_role_id], enrollment_kind: 'sep', effective_on_date: special_enrollment_period.effective_on, qle_id: qle.id, market_kind: qle.market_kind}
