...
=======
    ...
    unless hbx_enrollment.shopping?
      ...
      waived_enrollment =  coverage_household.household.new_hbx_enrollment_from(employee_role: employee_role, coverage_household: coverage_household, benefit_group: nil, benefit_group_assignment: nil, qle: 'change_by_qle')
