class Products::QhpController < ApplicationController
  ...
  def comparison
    ...
    if (@market_kind == 'aca_shop' || @market_kind == 'fehb') && (@coverage_kind == 'health' || @coverage_kind == "dental") # 2016 plans have shop dental plans too.
      ...
      effective_on = @hbx_enrollment.employee_role.census_employee.active_benefit_package&.start_on
      products = @hbx_enrollment.sponsored_benefit.products(effective_on || @hbx_enrollment.effective_on)
