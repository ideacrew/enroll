module Events
  class ResidencyVerificationRequestsController < ::ApplicationController
    ...
    def call(event_name, e_start, e_end, msg_id, payload)
      ...
      notify("acapi.info.events.residency.verification_request", {:body => event_payload, :individual_id => individual.hbx_id, :retry_deadline => (TimeKeeper.datetime_of_record + 24.hours).to_i})
    end
