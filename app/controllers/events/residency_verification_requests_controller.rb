module Events
  class ResidencyVerificationRequestsController < ::ApplicationController
    ...
    def call(event_name, e_start, e_end, msg_id, payload)
      ...
      event_payload = render_to_string "residency_verification_request", :formats => ["xml"], :locals => { :individual => individual }

      notify("acapi.info.events.residency.residency_verification_request", {:body => event_payload, :individual_id => individual.hbx_id, :retry_deadline => (Time.now + 24.hours).to_i})
    end
