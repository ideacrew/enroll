class PaymentTransactionsController < ApplicationController
  ...
  def generate_saml_response
    connect_test = HTTParty.get(SamlInformation.kp_pay_now_url) #checks to see if EA can connect to carrier payment portal.
    ...
    render json: {"SAMLResponse": @saml_response, status: connect_test.code, error: nil}
