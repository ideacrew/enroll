  ...
  module Services
    class CopayPerDayService < BaseService
      ...
      def in_network_process
        ...
        elsif record.co_insurance_in_network_tier_1.gsub("%","").to_i == 100 && number.to_i.zero? #ticket_42694
      ...
      def out_network_process
        ...
        "Not covered. You are responsible for the full cost." if record.co_insurance_out_of_network.gsub("%","").to_i == 100 && number.to_i.zero? #ticket_42694
      end
