...
class UnassistedPlanCostDecorator < SimpleDelegator
  ...
  def premium_for(member)
    (::BenefitMarkets::Products::ProductRateCache.lookup_rate(__getobj__, schedule_date, age_of(member), "R-#{Settings.aca.state_abbreviation.upcase}001") * large_family_factor(member)).round(2) rescue 0
  end
