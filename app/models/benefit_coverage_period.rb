...
class BenefitCoveragePeriod
  ...
  def elected_plans_by_enrollment_members(hbx_enrollment_members, coverage_kind, tax_households=nil, market=nil, family_member_ids=nil)
    ...
    Plan.individual_plans(coverage_kind: coverage_kind, active_year: start_on.year, tax_households: tax_households, hbx_enrollment: hbx_enrollment).by_plan_ids(elected_plan_ids).entries
  end
