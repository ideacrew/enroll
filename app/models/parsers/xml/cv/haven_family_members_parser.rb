module Parsers::Xml::Cv
  class HavenFamilyMembersParser
    ...
    element :magi_medicaid_monthly_household_income, Boolean, tag: 'magi_medicaid_monthly_household_income'
    element :magi_medicaid_monthly_income_limit, Boolean, tag: 'magi_medicaid_monthly_income_limit'
    element :magi_as_percentage_of_fpl, Boolean, tag: 'magi_as_percentage_of_fpl'
    element :magi_medicaid_category, Boolean, tag: 'magi_medicaid_category'
    element :medicaid_household_size, Boolean, tag: 'medicaid_household_size'
