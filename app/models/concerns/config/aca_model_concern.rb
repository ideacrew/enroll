module Config::AcaModelConcern
  ...
  included do
    ...
    delegate :is_reset_password_action_enabled?, to: :class
    delegate :is_edit_user_action_enabled?, to: :class
    delegate :is_view_login_history_action_enabled?, to: :class
    delegate :is_unlock_or_lock_account_action_enabled?, to: :class
  ...
  class_methods do
    ...
    def is_reset_password_action_enabled?
      @@reset_password_action_enabled ||= Settings.aca.admin_actions_available.include? "reset_password"
    end

    def is_unlock_or_lock_account_action_enabled?
      @@unlock_or_lock_account_action_enabled ||= Settings.aca.admin_actions_available.include? "unlock_or_lock_account"
    end

    def is_view_login_history_action_enabled?
      @@view_login_history_action_enabled ||= Settings.aca.admin_actions_available.include? "view_login_history"
    end

    def is_edit_user_action_enabled?
      @@edit_user_action_enabled ||= Settings.aca.admin_actions_available.include? "edit_user"
    end
