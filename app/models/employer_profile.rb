...
#  field :conversion_carrier_id, type: BSON::ObjectId, default: nil
  ...
  def hire_broker_agency(new_broker_agency, start_on = today)
    SponsoredBenefits::Organizations::BrokerAgencyProfile.assign_employer(broker_agency: new_broker_agency, employer: self, office_locations: parent.office_locations)
