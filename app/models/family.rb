...
class Family
 ...
 # after_destroy :remove_family_search_record
  ...
  scope :by_enrollment_individual_market,     ->{ where(:"households.hbx_enrollments.kind" => ["individual", "unassisted_qhp", "insurance_assisted_qhp", "streamlined_medicaid", "emergency_medicaid", "hcr_chip"]) }
