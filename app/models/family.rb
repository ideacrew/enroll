 ...
 # after_destroy :remove_family_search_record
  ...
  def currently_enrolled_products(enrollment)
    ...
    if enrolled_enrollments.blank?
      enrolled_enrollments = active_household.hbx_enrollments.enrolled_renewing_and_terminated.by_coverage_kind(enrollment.coverage_kind).by_terminated_period((enrollment.effective_on - 1.day))
    end
