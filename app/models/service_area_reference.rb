class ServiceAreaReference
  ...
  field :covers_entire_state, type: Boolean, default: false
  ...
  validates_presence_of :service_area_id, :service_area_name, :covers_entire_state

  validates :county_name, :serves_partial_county, presence: true,
   unless: Proc.new { |a| a.covers_entire_state? }
