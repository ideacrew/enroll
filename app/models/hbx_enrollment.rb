...
class HbxEnrollment
  ...
  Kinds = %W[unassisted_qhp insurance_assisted_qhp employer_sponsored employer_sponsored_cobra streamlined_medicaid emergency_medicaid hcr_chip individual coverall]
  ...
  scope :individual_market,   ->{ where(:kind.nin => ["employer_sponsored", "employer_sponsored_cobra", "coverall"]) }
