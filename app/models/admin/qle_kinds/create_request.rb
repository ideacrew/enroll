module Admin
  module QleKinds
    class CreateRequest
      ...
      option :is_self_attested, Dry::Types['params.bool'], optional: true
      option :visible_to_customer, Dry::Types['params.bool'], optional: true
      option :effective_on_kinds, Dry::Types['coercible.array'], optional: true
      option :post_event_sep_in_days, Dry::Types['coercible.string'], optional: true
      option :pre_event_sep_in_days, Dry::Types['coercible.string'], optional: true
      ...
      option :questions, Dry::Types['coercible.array']
