module Queries
  class EmployerPlanOfferings
    ...
    delegate :single_carrier_offered_health_plans, :metal_level_offered_health_plans, :single_option_offered_health_plans, :sole_source_offered_health_plans, :single_option_offered_dental_plans, :to => :strategy
