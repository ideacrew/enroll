      ...
      datatable do
        ...
        table_column :actions, :width => '50px', :proc => Proc.new { |row|
          dropdown = [
           ...
           ['Create Eligibility', new_eligibility_exchanges_hbx_profiles_path(person_id: row.primary_applicant.person.id, family: row.id, family_actions_id: "family_actions_#{row.id}"),
            new_eligibility_family_member_link_type(row, pundit_allow(HbxProfile, :can_add_pdc?))],
