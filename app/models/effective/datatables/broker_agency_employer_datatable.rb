    ...
    module Datatables
      class BrokerAgencyEmployerDatatable < ::Effective::MongoidDatatable
        datatable do
          ...
          table_column :actions, :width => '50px', :proc => Proc.new { |row|
            dropdown = [
             ...
             ['Create Quote', 'some-quote-create-path', 'static'],
        ...
        def collection
          ...
          # Prospective
          prospective_employers = SponsoredBenefits::Organizations::PlanDesignOrganization.by_broker_agency_profile(profile_id)
