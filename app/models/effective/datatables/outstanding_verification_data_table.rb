  ...
  module Datatables
    class OutstandingVerificationDataTable < Effective::MongoidDatatable
      datatable do
        ...
        table_column :verification_due, :label => 'Verification Due',:proc => Proc.new { |row|  row.best_verification_due_date || TimeKeeper.date_of_record + 95.days }, :filter => false, :sortable => true
