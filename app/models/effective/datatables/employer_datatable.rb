...
#          }, :filter => false, :sortable => false
        ...
        table_column :actions, :width => '50px', :proc => Proc.new { |row|
          dropdown = [
           ...
           [text_to_display(row.employer_profile), disable_ssn_requirement_exchanges_hbx_profiles_path(ids: [row]), 'post_ajax'],
      ...
      def text_to_display(employer)
        employer.is_ssn_disabled? ? "Enable SSN/TIN" : "Disable SSN/TIN"
      end
