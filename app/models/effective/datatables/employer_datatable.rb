...
#          }, :filter => false, :sortable => false
        ...
        table_column :actions, :width => '50px', :proc => Proc.new { |row|
          dropdown = [
           ...
           ['Force Publish', edit_force_publish_exchanges_hbx_profiles_path(ids: [row], row_actions_id: "family_actions_#{row.id.to_s}"), force_publish_link_type(row, pundit_allow(HbxProfile, :can_force_publish?))]
          ]
