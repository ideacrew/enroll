  ...
  module Datatables
    class SepTypeDataTable < Effective::MongoidDatatable
      ...
      datatable do
        ...
        table_column :published_by, :label => l10n("datatables.sep_type_data_table.published_by"), :proc => proc { |row| User.find(row.published_by).person.full_name rescue "admin"}, :filter => false, :sortable => false
