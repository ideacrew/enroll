module SponsoredBenefits
  module BenefitMarkets
    class AcaIndividualConfiguration < Configuration
      ...
      field :open_enrl_start_on,   as: :open_enrollment_start_on, type: Integer, default: Date.new(2017,11,1)
      field :open_enrl_end_on,     as: :open_enrollment_end_on, type: Integer, default: Date.new(2017,01,31)
