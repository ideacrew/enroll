module Transcripts
  ...
  class Payload
    ...
    #         "body"=>"Access Health CT is the District of Columbia's on-line marketplace to shop, compare, and select health insurance that meets your health needs and budgets.",
    #         "created_at"=>"Sun, 09 Oct 2016 21:45:05 +0000",
    #         "folder"=>nil,
    #         "from"=>"Access Health CT",
    #         "message_read"=>false,
    #         "parent_message_id"=>nil,
    #         "sender_id"=>nil,
    #         "subject"=>"Welcome to Access Health CT",
    #         "to"=>nil}]},
    #    "is_active"=>true,
    #    "is_disabled"=>nil,
    #    "is_incarcerated"=>nil,
