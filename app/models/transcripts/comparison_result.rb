module Transcripts
  ...
  class Payload
    ...
    #         "body"=>"Cover ME is the District of Columbia's on-line marketplace to shop, compare, and select health insurance that meets your health needs and budgets.",
