module Factories
  class PlanYearFactory
    def self.default_dates_for_coverage_starting_on(coverage_start_date)
      ...
      open_enrollment_end_on = Date.new(end_of_open_enrollment_month_start.year, end_of_open_enrollment_month_start.month, Settings.aca.shop_market.renewal_application.monthly_open_enrollment_end_on)
      {
