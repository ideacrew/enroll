module Factories
  class ShopEnrollmentRenewalFactory
    ...
    def renew_coverage
      if active_renewals.blank? && passive_renewals.blank?
    ...
    def renewal_enrollments
      ...
      id_list = renewing_plan_year.benefit_groups.pluck(:_id)
    ...
    def current_enrollments
      ...
      id_list = employer.active_plan_year.benefit_groups.pluck(:_id)
    ...
    def generate_passive_waiver
      if active_enrollments.blank?
        renew_waived_enrollment(active_waiver)
      end
    end
    ...
    def renew_waived_enrollment(waived_enrollment = nil)
      ...
      renewal_enrollment.coverage_kind = waived_enrollment.try(:coverage_kind) || "health"
      renewal_enrollment.enrollment_kind = "open_enrollment"
      renewal_enrollment.kind = waived_enrollment.try(:kind) || "employer_sponsored"
