...
private
  ...
  def validate_and_set_effective_on
    ...
    if employee_role.employer_profile.plan_years.published_plan_years_by_date(effective_on).blank?
      plan_year_start_on = employee_role.employer_profile.show_plan_year.start_on
