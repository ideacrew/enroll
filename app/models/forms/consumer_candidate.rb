  ...
  class ConsumerCandidate
    ...
    def uniq_ssn_dob
      ...
      if person_with_ssn != person_with_ssn_dob
        errors.add(:base, l10n("insured.consumer_roles.match.ssn_dob_error", state_abbreviation: EnrollRegistry[:enroll_app].settings(:state_abbreviation).item, contact_center_phone_number: Settings.contact_center.phone_number))
