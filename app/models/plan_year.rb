class PlanYear
  ...
  aasm do
    ...
    event :publish, :after => :record_transition do
      ...
      transitions from: :draft, to: :enrolling, :guard => [:is_application_eligible?, :is_event_date_valid?], :after => [:accept_application, :initial_employer_approval_notice, :record_sic_and_rating_area]
      transitions from: :draft, to: :published, :guard => :is_application_eligible?, :after => [:initial_employer_approval_notice, :record_sic_and_rating_area]
