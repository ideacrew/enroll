...
#    eligible_to_enroll.select{ |ce| ce.has_active_health_coverage?(self) }
  ...
  aasm do
    ...
    state :enrolling, :after_enter => [:send_employee_invites, :initial_employer_open_enrollment_begins, :link_census_employees] # Published plan has entered open enrollment
