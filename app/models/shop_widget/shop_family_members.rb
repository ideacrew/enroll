module ShopWidget
  class ShopFamilyMembers
    ...
    field :mem2_num, type: String
    field :mem2_pct, type: Integer
    field :mem3_num, type: String
    field :mem3_pct, type: String
    field :mem4_num, type: Integer
    field :mem4_pct, type: String
    field :mem5_num, type: String
    field :mem5_pct, type: Integer
    field :mem6_num, type: String
