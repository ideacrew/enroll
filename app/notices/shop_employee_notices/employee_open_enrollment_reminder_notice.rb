class ShopEmployeeNotices::EmployeeOpenEnrollmentReminderNotice < ShopEmployeeNotice
  ...
  def append_data
    ...
    if employer.is_new_employer?
      plan_year = census_employee.active_benefit_group_assignment.benefit_package.benefit_application
    elsif employer.is_renewing_employer?
      plan_year = census_employee.renewal_benefit_group_assignment.benefit_package.benefit_application
    end
