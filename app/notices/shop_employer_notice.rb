class ShopEmployerNotice < Notice
  ...
  def build
    ...
    address = employer_profile.organization.mailing_address.present? ? employer_profile.organization.mailing_address : employer_profile.organization.primary_office_location.address
