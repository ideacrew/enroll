class IvlNotice < Notice
  ...
  def deliver
    ...
    if @secure_message_recipient.consumer_role.can_receive_electronic_communication?
      send_generic_notice_alert
    end

    if @secure_message_recipient.consumer_role.can_receive_paper_communication?
      store_paper_notice
    end
  end
