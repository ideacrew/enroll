class IvlNotices::IvlBacklogVerificationNoticeUqhp < IvlNotice
  ...
  def check_for_unverified_individuals
    ...
    enrollments = HbxEnrollment.where(family_id: family.id, :is_any_enrollment_member_outstanding => true, :effective_on => { :"$gte" => TimeKeeper.date_of_record.beginning_of_year, :"$lte" => TimeKeeper.date_of_record.end_of_year }, :kind => "individual")
