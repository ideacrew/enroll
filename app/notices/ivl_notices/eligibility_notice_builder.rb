...
module IvlNotices
  # apparently this needs a comment
  class EligibilityNoticeBuilder < IvlNotice
    ...
    def append_tax_households(tax_household)
      PdfTemplates::TaxHousehold.new({
                                       csr_percent_as_integer: tax_household.preferred_eligibility_determination.csr_percent_as_integer.to_i,
                                       max_aptc: tax_household.preferred_eligibility_determination.max_aptc.to_i,
                                       aptc_csr_annual_household_income: tax_household.preferred_eligibility_determination.aptc_csr_annual_household_income.to_i,
                                       aptc_annual_income_limit: tax_household.preferred_eligibility_determination.aptc_annual_income_limit.to_i,
                                       csr_annual_income_limit: tax_household.preferred_eligibility_determination.csr_annual_income_limit.to_i
                                     })
    end
