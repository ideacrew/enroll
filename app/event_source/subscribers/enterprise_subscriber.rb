...
module Subscribers
  ...
  class EnterpriseSubscriber
    ...
    subscribe(
      ...
      Operations::Eligibilities::Notices::RequestDocumentReminderNotices.new.call(date_of_record: payload[:date_of_record]) if EnrollRegistry.feature_enabled?(:aca_individual_market)
