    ...
    class RrvMdcrDeterminationSubscriber
      ...
      subscribe(:on_magi_medicaid_application_renewal_eligibilities_medicare_determined) do |delivery_info, _metadata, response|
        ...
        if result.success?
          ...
          logger.info "FdshGateway::RrvMdcrDeterminationSubscriber: invoked on_magi_medicaid_application_renewal_eligibilities_mdcr_determined nacked with failure, errors: #{errors}"
