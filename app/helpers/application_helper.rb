module ApplicationHelper
  ...
  def copyright_notice
    raw("<span class='copyright'><i class='fa fa-copyright fa-lg' aria-hidden='true'></i> #{Settings.site.copyright_period_start}-#{Time.now.year} #{Settings.site.short_name}. All Rights Reserved.</span>")
  end
