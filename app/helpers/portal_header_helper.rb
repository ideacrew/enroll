module PortalHeaderHelper
  ...
  def portal_display_name(controller)
    if current_user.nil?
      ...
      link_to "#{image_tag 'icons/icon-expert.png'} &nbsp; I'm a Broker".html_safe, broker_agencies_profile_path(id: current_user.person.active_broker_staff_roles.first.broker_agency_profile_id), class: "portal"
