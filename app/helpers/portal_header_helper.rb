module PortalHeaderHelper
  ...
  def portal_display_name(controller)
    if current_user.nil?
      ...
      link_to "#{image_tag 'icons/icon-expert.png'} &nbsp; I'm a Broker".html_safe, main_app.broker_agencies_profile_path(id: @broker_agency_profile_id || params[:id] ), class: "portal"
