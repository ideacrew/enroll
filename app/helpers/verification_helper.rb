module VerificationHelper
  ...
  def enrollment_group_unverified?(person)
    person.primary_family.active_family_members.any? {|member| member.person.consumer_role.aasm_state == "verifications_outstanding" if member.try(:person).try(:consumer_role)}
  end
