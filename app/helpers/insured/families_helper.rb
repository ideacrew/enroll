module Insured::FamiliesHelper
  ...
  def disable_make_changes_button?(hbx_enrollment)
    ...
    # Enable the button under these conditions
      ...
      # 3) special enrollment period id not populated for an enrollment
      # 4) qle enrolmlent period check
    ...
    return false if hbx_enrollment.is_special_enrollment? && hbx_enrollment.special_enrollment_period.blank?
