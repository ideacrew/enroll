  ...
  module PlanShopping
    module ReceiptHelper
      ...
      def has_any_previous_kaiser_enrollments?
        ...
        all_kaiser_enrollments = @enrollment.family.hbx_enrollments.with_product.select { |enr| enr.product.issuer_profile.legal_name == carrier && enr.effective_on.year == @enrollment.effective_on.year }
