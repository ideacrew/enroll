module Insured
  module GroupSelectionHelper
    ...
    def health_relationship_benefits_for_composite(benefit_group)
      if benefit_group.present?
    ...
    def shop_health_and_dental_relationship_benfits(employee_role, benefit_group)
      ...
      if benefit_group.sole_source?
        health_offered_relationship_benefits = health_relationship_benefits_for_composite(benefit_group)
      else
