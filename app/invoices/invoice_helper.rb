...
# module Prawn::Graphics
  ...
  def payment_page_for_initial_employer
    ...
    @pdf.move_down 72
    @pdf.text_box "Please review the billing summary. This is a consolidated bill for all your benefits through the Connecticut #{site_short_name}. Please pay the Total Amount Due.", :at => [address_x, @pdf.cursor]
    @pdf.move_down 48
    ...
    @pdf.move_down 24
    @pdf.text_box "\u2022 Call the Connecticut #{site_short_name} Customer Service at 888-813-9220 (TTY #{contact_center_tty_number})", :at => [address_x, @pdf.cursor]
    @pdf.move_down 24
