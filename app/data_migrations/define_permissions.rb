  ...
  def initial_hbx
    Permission
      ...
      .update_attributes!(modify_family: true, modify_employer: true, revert_application: true, list_enrollments: true,
                          ...
                          view_agency_staff: true, manage_agency_staff: true, can_access_age_off_excluded: true)
    Permission
    ...
    Permission
      ...
      .update_attributes!(modify_family: true, modify_employer: true, revert_application: true, list_enrollments: true,
                          ...
                          view_the_configuration_tab: true, can_submit_time_travel_request: false, can_access_age_off_excluded: true)
    Permission
    ...
    Permission
      ...
      .update_attributes!(modify_family: true, modify_employer: true, revert_application: true, list_enrollments: true,
                          ...
                          view_admin_tabs: true,  view_the_configuration_tab: true, can_submit_time_travel_request: false,
                          view_agency_staff: true, manage_agency_staff: true, can_send_secure_message: true, can_manage_qles: true, can_access_age_off_excluded: true
                        )
    Permission
