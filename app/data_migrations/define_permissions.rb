...
#The convention for a privilege group 'x' is  'modify_x', or view 'view_x'
  ...
  def initial_hbx
    Permission
      ...
      .update_attributes!(modify_family: true, modify_employer: true, revert_application: true, list_enrollments: true,
                          ...
                          view_agency_staff: true, manage_agency_staff: true, terminate_employee: false)
    Permission
      ...
      .update_attributes!(modify_family: true, modify_employer: false, revert_application: false, list_enrollments: true,
                          ...
                          view_the_configuration_tab: true, can_submit_time_travel_request: false, terminate_employee: false)
    Permission
    ...
    Permission
      ...
      .update_attributes!(modify_family: true, modify_employer: true, revert_application: true, list_enrollments: true,
                          ...
                          view_admin_tabs: true,  view_the_configuration_tab: true, can_submit_time_travel_request: false,
                          view_agency_staff: true, manage_agency_staff: true, terminate_employee: true
                        )
    Permission
  ...
  def hbx_admin_terminate_employee
    Permission.super_admin.update_attributes(terminate_employee: true)
    Permission.hbx_tier3.update_attributes(terminate_employee: true)
  end
