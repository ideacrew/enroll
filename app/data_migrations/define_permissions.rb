...
#The convention for a privilege group 'x' is  'modify_x', or view 'view_x'
  ...
  def initial_hbx
    ...
    Permission.create(name: 'hbx_staff',
                      modify_family: true,
                      ...
                      approve_broker: true,
                      approve_ga: true,
                      can_update_ssn: false,
                      can_complete_resident_application: false,
                      can_add_sep: false,
                      can_lock_unlock: true,
                      can_view_username_and_email: false,
                      can_reset_password: false,
                      modify_admin_tabs: true,
                      view_admin_tabs: true)
    Permission.create(name: 'hbx_read_only',
                      modify_family: true,
                      ...
                      view_admin_tabs: true)
    Permission.create(name: 'hbx_csr_supervisor',
                      modify_family: true,
                      modify_employer: true,
                      revert_application: true,
                      list_enrollments: true,
    ...
    Permission.create(name: 'hbx_csr_tier2',
                      modify_family: true,
                      modify_employer: true,
                      revert_application: false,
                      ...
                      modify_admin_tabs: false,
                      view_admin_tabs: false)
    Permission.create(name: 'hbx_csr_tier1',
                      modify_family: true,
                      modify_employer: false,
                      revert_application: false,
                      list_enrollments: false,
    ...
    Permission.create(name: 'developer',
                      ...
                      modify_admin_tabs: false,
                      view_admin_tabs: true)
    Permission.create(name: 'hbx_tier3',
                      modify_family: true,
                      modify_employer: true,
                      revert_application: true,
                      list_enrollments: true,
