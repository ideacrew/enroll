      ...
      if organization.nil? || plan_id.nil?
        ...
        if employer_profile.present?
          ...
          if active_plan_year.present?
            ...
            puts "Active plan year is not present employer_profile with fein #{organization.fein}"
          end
        else
          puts "Employer Profile is not present for organization with fein #{organization.fein}"
        end
      end
    rescue
      puts e.message
