        ...
        CSV.open(file_name_applicants_income, "wb") do |income_csv|
          ...
          CSV.open(file_name_applicants_benefit, "wb") do |benefit_csv|
            ...
            CSV.open(file_name_applicants_deduction, "wb") do |deduction_csv|
              ...
              # core_29_app_ids = ['5a33fa79eab5e7b6ae0001a4','59cbcefdeab5e7027b000082']
              ...
              core_29_applications.each do |application|
                ...
                application_csv << [
                    ...
                    application.integrated_case_id,
                    application.applicant_kind,
                    application.request_kind,
                    application.motivation_kind,
                    application.is_joint_tax_filing,
                    "draft",
                    application.is_renewal_authorized,
                    application.renewal_base_year,
                    application.years_to_renew,
                    application.is_requesting_voter_registration_application_in_mail,
                    application.us_state,
                    application.medicaid_terms,
                    application.medicaid_insurance_collection_terms,
                    application.report_change_terms,
                    application.parent_living_out_of_home_terms,
                    application.attestation_terms,
                    application.submission_terms,
                    application.request_full_determination,
                    application.is_ridp_verified,
                    application.has_eligibility_response
