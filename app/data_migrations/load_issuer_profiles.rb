...
class LoadIssuerProfiles < MongoidMigrationTask
  ...
  def migrate
    issuer_profile_data = [
      ...
      {fein: "237442369", issuer_hios_ids: "88806", legal_name: "Fallon Health", abbreviation: "FCHP", hbx_carrier_id: 20005, shop_health: true },
      ...
      {fein: "234547586", issuer_hios_ids: "41304", legal_name: "Neighborhood Health Plan", abbreviation: "NHP", hbx_carrier_id: 20010, shop_health: true },
      ...
      {fein: "050513223", issuer_hios_ids: "18076", legal_name: "Altus", abbreviation: "ALT", hbx_carrier_id: 20001, shop_dental: true },
