...
class LoadIssuerProfiles < MongoidMigrationTask
  ...
  def migrate
    issuer_profile_data = [
      {fein: "123654789", issuer_hios_ids: ["96667"], legal_name: "Harvard Pilgrim Health Care", abbreviation: "HPHC", hbx_carrier_id: 30001, ivl_health: true },
      {fein: "456321456", issuer_hios_ids: ["48396"], legal_name: "Anthem, Inc.", abbreviation: "ANT", hbx_carrier_id: 30008, ivl_health: true },
      {fein: "123654789", issuer_hios_ids: ["33653"], legal_name: "Community Health Options", abbreviation: "CHO", hbx_carrier_id: 30003, ivl_health: true },
      {fein: "785236985", issuer_hios_ids: ["76302"], legal_name: "Renaissance Life & Health Insurance", abbreviation: "RENA", hbx_carrier_id: 30004, ivl_dental: true },
      {fein: "741258963", issuer_hios_ids: ["50165"], legal_name: "Maine Dental Service", abbreviation: "MDS", hbx_carrier_id: 30005, ivl_dental: true },
