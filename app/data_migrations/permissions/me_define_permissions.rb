  ...
  def initial_hbx
    Permission
      ...
      .update_attributes!(modify_family: true, modify_employer: false, revert_application: false, list_enrollments: true,
                          ...
                          view_the_configuration_tab: false, can_submit_time_travel_request: false, can_access_pay_now: true, can_access_age_off_excluded: true,
    ...
    Permission
      ...
      .update_attributes!(modify_family: true, modify_employer: true, revert_application: true, list_enrollments: true,
                          send_broker_agency_message: true, approve_broker: true, approve_ga: true, can_update_ssn: true, can_complete_resident_application: true,
                          can_add_sep: true, can_lock_unlock: true, can_view_username_and_email: true, can_reset_password: true, modify_admin_tabs: true,
                          view_admin_tabs: true, can_extend_open_enrollment: true, view_the_configuration_tab: true, can_submit_time_travel_request: true,
