  ...
  def csr_hbx_permissions
    Permission
      ...
      .update_attributes!(modify_family: true, modify_employer: false, revert_application: false, list_enrollments: true, can_add_sep: false,
                          ...
                          can_terminate_enrollment: false, change_enrollment_end_date: false, can_change_username_and_email: false, can_drop_enrollment_members: false)
    Permission
      ...
      .update_attributes!(modify_family: true, modify_employer: true, revert_application: true, list_enrollments: true, can_send_secure_message: false, can_add_sep: false,
                          ...
                          can_reinstate_enrollment: true, can_cancel_enrollment: true, can_terminate_enrollment: true, change_enrollment_end_date: true, can_drop_enrollment_members: true)
    Permission
  ...
  def initial_hbx
    ...
    Permission
      ...
      .update_attributes!(modify_family: true, modify_employer: true, revert_application: true, list_enrollments: true,
                          ...
                          change_enrollment_end_date: true, can_drop_enrollment_members: true)
    Permission
