...
class MoveEnrollmentBetweenTwoAccount < MongoidMigrationTask
  def migrate
    ...
    hbx_enrollment_hbx_id = ENV['enrollment_hbx_id']
    ...
    if gp.nil?
      ...
      #enrollment_hbx_id = HbxEnrollment.by_hbx_id(hbx_enrollment_hbx_id)
      hbx_enrollment= bp.primary_family.active_household.hbx_enrollments.where(hbx_id:hbx_enrollment_hbx_id).first
        ...
        if hbx_enrollment.is_shop?
          ...
          if gp.employee_roles.empty? ||  bp.employee_roles.empty?
            ...
            if gp.consumer_role.present? && bp.consumer_role.present?
              ...
              bp.primary_family.active_household.delete_hbx_enrollment(hbx_enrollment_hbx_id)
            else
