...
class RemoveAllDuplicateDependents < MongoidMigrationTask
  def initialize_instance_variables(most_recent_active_enrollment_hbx_id)
  ...
  def authority_family_members_attached_to_most_recent_active_enrollment(active_enrollment)
  ...
  def migrate
    begin
      initialize_instance_variables(most_recent_active_enrollment_hbx_id)
      ...
      destroy_coverage_household_and_tax_household_members(@family)
