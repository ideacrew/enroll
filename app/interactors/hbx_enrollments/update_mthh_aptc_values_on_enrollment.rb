...
# UpdateMthhAptcValuesOnEnrollment is an interactor that updates the aptc values on an enrollment
  class UpdateMthhAptcValuesOnEnrollment
    ...
    before do
      ...
      context.fail!(message: "new_effective_on is required") unless context.new_effective_on.present?
    end
    ...
    # - new_effective_on
    def call
      result = ::Operations::PremiumCredits::FindAptc.new.call({ hbx_enrollment: enrollment, effective_on: effective_on, exclude_enrollments_list: exclude_enrollments_list })
