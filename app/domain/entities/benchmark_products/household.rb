...
module Entities
  module BenchmarkProducts
    class Household < Dry::Struct
      ...
      attribute :total_health_benchmark_ehb_premium, ::AcaEntities::Types::Money.optional.meta(omittable: true)
      ...
      attribute :total_dental_benchmark_ehb_premium, ::AcaEntities::Types::Money.optional.meta(omittable: true)
