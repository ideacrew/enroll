...
module Entities
  module BenchmarkProducts
    class Household < Dry::Struct
      attribute :household_id, Types::String.meta(omittable: false)
      ...
      attribute :health_product_title, Types::String.optional.meta(omittable: true)
      attribute :health_product_csr_variant_id, Types::String.optional.meta(omittable: true)
