    ...
    class FetchSlcsp
      ...
      def transform(slcsp_info)
        ...
        slcsp_info.each_pair do |person_hbx_ids, premiums|
          ...
          premium_hash[:health_only_slcsp_premiums] = premiums[:health_only].values.compact if premiums[:health_only].present?
          premium_hash[:health_and_dental_slcsp_premiums] = premiums[:health_and_dental].values.compact if premiums[:health_and_dental].present?
          premium_hash[:health_and_ped_dental_slcsp_premiums] = premiums[:health_and_ped_dental].values.compact if premiums[:health_and_ped_dental].present?
