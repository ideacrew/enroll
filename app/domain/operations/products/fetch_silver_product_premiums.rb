  ...
  module Products
    ...
    class FetchSilverProductPremiums
      ...
      def call(params)
        ...
        product_premiums  = yield fetch_product_premiums(values[:products], family_members, values[:effective_date], values[:rating_area_exchange_provided_code].to_s, values[:rating_area_id].to_s)
      ...
      def fetch_product_premiums(products, family_members, effective_date, rating_area_exchange_provided_code, _rating_area_id)
