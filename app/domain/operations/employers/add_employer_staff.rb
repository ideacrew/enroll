  ...
  module Employers
    ...
    class AddEmployerStaff
      ...
      def call(params)
        ...
        employer_staff_entity = yield create_employer_staff_record(values, @profile)
        result = yield persist(employer_staff_entity, @person)
      ...
      def validate_params(params)
        result = Validators::Employers::AddEmployerStaffContract.new.call(params)
        if result.success?
          Success(result.to_h)
        else
      ...
      def create_employer_staff_record( values, profile)
        Operations::Employers::EmployerStaffRoles::Create.new.call(params: values, profile: profile)
      end

      def persist(er_entity, person)
        result = Try do
