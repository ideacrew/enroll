...
module Operations
  module MagiMedicaid
    ...
    class Apply
      ...
      def apply(medicaid_application_params)
        result = ::MagiMedicaid::Applications::Create.new.call(params: medicaid_application_params)
      ...
      def applicants_attributes(family)
        family.active_family_members.inject([]) do |members_array, family_member|
          member_attrs_result = ::Operations::MagiMedicaid::ParseApplicant.new.call({family_member: family_member})
