$(document).ready(function() {
  if ($('.run-glossary').length) {
    var terms = [
      ...
      {
        "term": "Accreditation",
        "description": "All health plans available through DC Health Link have been reviewed by an independent, third-party organization to validate (accredit) that the plans meet quality standards required by the <a href='\/glossary#affordable_care_act' target='_blank'>Affordable Care Act<\/a> and the District of Columbia."
      },
      {
      ...
      {
        "term": "Benefit Year",
        "description": "If you sign up for <a href='\/glossary#individual_&_family_health_insurance' target='_blank'>Individual & Family health insurance<\/a> through DC Health Link, the benefit year is the year when coverage is active. It begins on January 1 and ends on December 31, even if your coverage starts after January 1. Changes to <a href='\/glossary#covered_services' target='_blank'>covered services<\/a> or what you pay for health insurance are made at the beginning of the calendar year. If you sign up for <a href='\/glossary#employer-sponsored_health_insurance' target='_blank'>employer-sponsored coverage<\/a> through DC Health Link, the benefit year begins when your coverage goes into effect and ends when your entire group\u2019s benefit year ends, even if you started after your group started. Changes to covered services or what you pay for health insurance are made at the beginning of the calendar year."
      },
      {
        "term": "Benefits",
      ...
      {
        "term": "Broker",
        "description": "Brokers are licensed under District law to sell <a href='\/glossary#health_insurance' target='_blank'>health insurance<\/a> through DC Health Link to individuals, families, small businesses and their employees. Brokers have been trained by DC Health Link, can recommend plans or <a href='\/glossary#plan_type' target='_blank'>plan types<\/a>, and perform activities on behalf of their clients as part of their professional licensing and training. There is no cost to use a Broker."
      },
      {
      ...
      },
      {
        ...
        "description": "An independent, non-profit consumer authority that powers DC Health Link's <a href='\/glossary#plan_match' target='_blank'>Plan Match<\/a> comparison tool, Prescription Drug search tool, and Doctor Directory."
      },
      {
        "term": "Copayment",
      ...
      },
      {
        ...
        "description": "A feature of DC Health Link's <a href='\/glossary#plan_match' target='_blank'>Plan Match<\/a> tool that allows you to filter plans and see the ones where your doctors are <a href='\/glossary#in-network' target='_blank'>in-network<\/a>."
      },
      {
      ...
      },
      {
        ...
        "description": "If you're a Native American, member of a <a href='\/glossary#federally_recognized_tribe' target='_blank'>federally recognized tribe<\/a>, <a href='\/glossary#alaskan_native' target='_blank'>Alaskan Native<\/a> Claims Settlement Act (ANCSA) corporation shareholder or otherwise eligible for services from the <a href='\/glossary#indian_health_service' target='_blank'>Indian Health Service<\/a>, Tribal Program, or Urban Indian Health Program, enhanced savings, benefits and protections are likely available to you through DC Health Link. You should apply for <a href='\/glossary#financial_assistance' target='_blank'>financial assistance<\/a> prior to choosing a health plan to determine the savings, benefits and protections available to you. "
      },
      {
        "term": "Navigator",
      ...
      {
        "term": "Plan Match",
        "description": "DC Health Link's health plan comparison tool powered by <a href='\/glossary#consumers&#39;_checkbook' target='_blank'>Consumers' CHECKBOOK<\/a>. Plan match helps you compare and choose a plan based on the features that are most important to you. See <a class='ext' href='https:\/\/dc.checkbookhealth.org\/hie\/dc\/2017\/' target='_blank'>Plan Match for Individuals & Families<\/a> or <a class='ext' href='https:\/\/dc.checkbookhealth.org\/shop\/dc\/' target='_blank'>Plan Match for Small Businesses & Employees<\/a>. "
      },
      {
      ...
      },
      {
        ...
        "description": "All plans available through DC Health Link include prescription drug coverage, but that doesn't mean that all plans cover your prescriptions. When you use DC Health Link's <a href='\/glossary#plan_match' target='_blank'>Plan Match<\/a> tool, you'll have the opportunity to enter the names of your <a href='\/glossary#prescription_drugs' target='_blank'>prescription drugs<\/a> and see which plans provide coverage. You should also check the insurance company's <a href='\/glossary#formulary' target='_blank'>formulary<\/a>."
      },
      {
        "term": "Prescription Drugs",
        "description": "A medication that legally requires your doctor to write an authorization for you to use it before a pharmacy can sell it to you. Most <a href='\/glossary#health_insurance' target='_blank'>health insurance<\/a> plans cover some prescription drug costs. If you take medications that require a prescription from your doctor, you'll want to make sure that the health plan you choose covers your specific medications by checking DC Health Link's <a href='\/glossary#plan_match' target='_blank'>Plan Match<\/a> tool and the insurance company's <a href='\/glossary#formulary' target='_blank'>formulary<\/a>."
      },
      {
      ...
      },
      {
        ...
        "description": "<a href='\/glossary#health_insurance' target='_blank'>Health insurance<\/a> offered by an employer, purchased through an insurance company or through a health insurance marketplace like the private plans available through DC Health Link. "
      },
      {
        "term": "QHP",
      ...
      },
      {
        ...
        "description": "A plan purchased through a <a href='\/glossary#health_insurance_marketplace' target='_blank'>health insurance marketplace<\/a>, such as the <a href='\/glossary#private_health_insurance' target='_blank'>private plans<\/a> available through DC Health Link."
      },
      {
    ...
    $(terms).each(function(i, term) {
      $('.run-glossary:contains(' + term.term + ')').each(function(i, matchingEl) {
        ...
        $(matchingEl).html($(matchingEl).html().replace(regex, `<span id='myTooltip' class="glossary" data-toggle="tooltip" data-trigger="click" title="<span class='close-icon pull-right' onclick='myToolTip(this)'></span><br /> ${text}" data-html="true">${term.term}</span>`));
      });
    })
    //$.ajax({
    //  cache: true,
