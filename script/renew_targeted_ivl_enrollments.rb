...
require 'csv'
year = ARGV[0]
read_filename = "#{Rails.root}/pids/#{year.to_i + 1}_ivl_enrollments_eligible_renewal_failures.csv"
write_filename = "#{Rails.root}/pids/#{year.to_i + 1}_ivl_enrollments_retriggered_renewals.csv"
