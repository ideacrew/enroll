...
clean_pol_ids.each do |p_id|
  ...
  # next if enrollment.benefit_group.employer_profile.is_conversion?
  # next if PlanYear::PUBLISHED.include?(enrollment.benefit_group.plan_year.aasm_state)
