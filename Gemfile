...
gem 'aca_entities',       git: 'https://github.com/ideacrew/aca_entities.git', branch: 'amqp_delayed_message_exchanges'
gem 'event_source',       git:  'https://github.com/ideacrew/event_source.git', branch: 'delayed_message_exchange'
