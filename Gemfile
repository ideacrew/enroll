...
gem 'bson',                     '~> 4.3'
gem 'carrierwave-mongoid', '~> 1.2', '>= 1.2.0', :require => 'carrierwave/mongoid'
gem 'mongoid', '~> 7.0.2'
gem 'mongo',                    '~> 2.6'
gem 'mongo_session_store', '~> 3.2', '>= 3.2.0'
gem 'mongoid-autoinc', '~> 6.0', '>= 6.0.3'
gem 'mongoid-history', '~> 0.8', '>= 0.8.1'
# gem 'mongoid-versioning',       '~> 1.2.0'
gem 'mongoid_userstamp', '~> 0.4', '>= 0.4.0', :path => "./project_gems/mongoid_userstamp-0.4.0"
...
gem 'i18n',                     '~> 1.5'
gem 'interactor',               '~> 3.0'
gem 'interactor-rails', '~> 2.2', '>= 2.2.0'
