class QhpBuilder
  ...
  def associate_plan_with_qhp
    ...
    if plan.present?
      ...
      puts "\rPlan Not Saved! Year: #{@qhp.active_year} :: Hios: #{@qhp.standard_component_id}, Market: #{@qhp.market_coverage}, Coverage kind: #{parse_coverage_kind}, Plan Name: #{@qhp.plan_marketing_name}"
      @qhp.plan = nil
    end
  end
