...
#  RAILS_ENV=production bundle exec rake migrations:update_benefit_group_assignment_details ce_id=123abc bga_id=123456 new_state="coverage_expired" action="unset_hbx_id"
