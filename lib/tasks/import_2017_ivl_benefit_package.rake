namespace :import do
  desc "import ivl benefit_package for 2017"
  task :ivl_benefit_package_for_2017 => :environment do
    puts "::: Creating IVL 2017 benefit packages :::"
    # BenefitPackages - HBX 2017
    hbx = HbxProfile.current_hbx
    # Second lowest cost silver plan
    slcsp_2017 = Plan.where(active_year: 2017).and(hios_id: "86052DC0400001-01").first
    ...
    unless bc_period = hbx.benefit_sponsorship.benefit_coverage_periods.detect { |bcp| bcp.start_on.year == 2017 }
    ...
    bc_period.save!
    puts "import benefit_package for 2017 successful."
  end
end
