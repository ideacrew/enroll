require 'rake'
# The task to run is RAILS_ENV=production bundle exec rake reports:backlog_notice_data_generate
namespace :reports do
  desc 'List of families who did not receive backlog notice'
  task backlog_notice_data_generate: :environment do
    count = 0
    ...
    if families.present?
      ...
      CSV.open(file_name, 'w', force_quotes: true) do |csv|
        ...
        families.each do |family|
          ...
          enrollments = family.enrollments.enrolled.where(
            :is_any_enrollment_member_outstanding => true,
            :effective_on => {
              :"$gte" => TimeKeeper.date_of_record.beginning_of_year,
      ...
      puts 'Families do not exist.. Quitting Rake Task!!'
    end
  end
end
