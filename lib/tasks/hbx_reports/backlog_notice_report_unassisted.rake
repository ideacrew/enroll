    ...
    if families.present?
      ...
      CSV.open(file_name, 'w', force_quotes: true) do |csv|
        ...
        families.each do |family|
          ...
          enrollments = family.enrollments.where(:is_any_enrollment_member_outstanding => true, :effective_on => { :"$gte" => TimeKeeper.date_of_record.beginning_of_year, :"$lte" =>  TimeKeeper.date_of_record.end_of_year }, :kind => "individual")
