module Parser
  class PlanCrossWalkParser
    ...
    element :plan_id_for_enrollees_aging_off_catastrophic_or_child_only_plan_fy, String, tag: "plan_id_for_enrollees_aging_off_catastrophic_or_child_only_plan_fy"
   ...
   def to_hash
      {
        ...
        plan_id_for_enrollees_aging_off_catastrophic_or_child_only_plan_fy: plan_id_for_enrollees_aging_off_catastrophic_or_child_only_plan_fy.present? ? plan_id_for_enrollees_aging_off_catastrophic_or_child_only_plan_fy.gsub(/\n/,'').strip : "",
