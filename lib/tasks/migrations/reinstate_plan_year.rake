...
# To run rake task: RAILS_ENV=production bundle exec rake migrations:reinstate_plan_year fein=271441903 plan_year_start_on=05/01/2017 update_renewal_enrollment=true update_current_enrollment=true
