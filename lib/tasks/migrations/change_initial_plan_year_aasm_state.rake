...
# For tansitions from renewing_enrolled to Enrolled(request from business)
#  RAILS_ENV=production bundle exec rake migrations:change_initial_plan_year_aasm_state fein=271441903 plan_year_start_on=05/01/2017 py_state="enrolled"
