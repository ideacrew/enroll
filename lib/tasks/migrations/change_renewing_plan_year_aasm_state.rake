...
# To run rake task: RAILS_ENV=production bundle exec rake migrations:change_renewing_plan_year_aasm_state fein=271441903 plan_year_start_on=05/01/2017 py_state_to=renewing_enrolled/renewing_draft
