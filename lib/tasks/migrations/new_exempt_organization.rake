...
# RAILS_ENV=production bundle exec rake migrations:new_exempt_organization fein=362739571 legal_name="UnitedHealthcare" abbreviation="UHIC" hbx_carrier_id="20012" issuer_hios_ids="31779" shop_health=true
