...
#RAILS_ENV=production bundle exec rake secure_message:disregard_termination_of_coverage_notice_er["876456787 555123457"]
...
namespace :secure_message do
  ...
  task :disregard_termination_of_coverage_notice_er, [:fein] => :environment do |t, args|
...
def create_secure_inbox_message_for_employer(employer_profile)
  body = "Your employees should please disregard the notice that they received on 11/25/2017 stating that their employer was not offering health coverage through the #{aca_state_name} #{site_short_name}. This notice was sent in error. We apologize for any inconvenience this may have caused."+ 
