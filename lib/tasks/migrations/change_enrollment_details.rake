...
# RAILS_ENV=production bundle exec rake migrations:change_enrollment_details hbx_id=397752 action="change_enrollment_status" new_aasm_state=coverage_selected
#For mutliple feins
