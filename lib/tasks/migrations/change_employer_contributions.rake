...
# RAILS_ENV=production bundle exec rake migrations:change_employer_contributions fein=264793467 aasm_state=renewing_enrolling coverage_kind=health/dental relationship=spouse premium=75 offered=true
