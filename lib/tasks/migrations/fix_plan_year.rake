...
# RAILS_ENV=production bundle exec rake migrations:fix_plan_year_state fein=521756243 start_on=11/01/2017 plan_year_status="expired" end_on=10/31/2017 terminated_on='' aasm_state='terminated' update_enrollments=true
