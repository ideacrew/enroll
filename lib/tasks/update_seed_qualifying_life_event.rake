    ...
    [
      ...
      { criteria: { title: "Change in APTC/CSR", market_kind: "individual" }, 
         attribs: { reason: "eligibility_change_income", 
                    ...
                    tool_tip: "Increases or decreases to income that may impact eligibility for or the dollar amount of household tax credits or cost-sharing reductions. (Only applies to those currently enrolled in a plan through Access Health CT)." 
                  } 
        },
      ...
      { criteria: { title: "Problem with my enrollment caused by Access Health CT", market_kind: "individual" }, 
         attribs: { reason: "enrollment_error_or_misconduct_hbx", 
                    title: "Enrollment error caused by Access Health CT", 
                    tool_tip: "You are not enrolled or are enrolled in the wrong plan because of an error made by Access Health CT or the Department of Health and Human Services" 
                  } 
        },
      ...
      { criteria: { title: "Problem with my enrollment caused by someone providing me with enrollment assistance", market_kind: "individual" }, 
         attribs: { reason: "enrollment_error_or_misconduct_non_hbx", 
                    ...
                    tool_tip: "You are not enrolled or are enrolled in the wrong plan because of an error made by a broker, in-person assister, or another expert trained by Access Health CT" 
                  } 
        },
      ...
      { criteria: { title: "My employer applied for small business coverage during open enrollment but was denied after open enrollment ended", market_kind: "individual" }, 
         attribs: { reason: "eligibility_change_employer_ineligible", 
                    ...
                    tool_tip: "Did not enroll in individual or family coverage because employer was applying to provide coverage through Access Health CT during open enrollment"
                  } 
        },
      ...
      { criteria: { title: "I was unable to enroll because of a system outage", market_kind: "individual" }, 
         attribs: { reason: "exceptional_circumstances_system_outage", 
                    ...
                    tool_tip: "A Access Health CT outage or outage in federal or local data sources close to an open enrollment or special enrollment deadline prevented enrollment" 
                  } 
        },
